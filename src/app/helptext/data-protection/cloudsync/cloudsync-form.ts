...
export default {
  ...
  direction_tooltip: T(
    "<i>PUSH</i> sends data to cloud storage. <i>PULL</i> \
 ...
 <i>Transfer Mode</i> to COPY."
  ...
  credentials_tooltip: T(
    "Select the cloud storage provider credentials from the\
 list of available Cloud Credentials."
  ...
  storage_class_tooltip: T(
    'Classification for each S3 object. Choose a\
 ...
 target="_blank">Amazon S3 Storage Classes</a> for more information.'
  ...
  b2_chunk_size_tooltip: T(
    "Files are split into chunks of this size \
 ...
 chunks."
  ...
  fast_list_tooltip: T(
    "[Use fewer transactions in exchange for more RAM.](https://rclone.org/docs/#fast-list)\
 This can also speed up or slow down the transfer."
  ),

  path_placeholder: T("Directory/Files"),
  path_tooltip: T(
    "Select the directories or files to be sent to the cloud\
 ...
 jobs to avoid overwriting existing files."
  ...
  transfer_mode_warning_sync: T(
    "<b>SYNC</b>: Files on the destination are <i><u>changed</u></i> to match those on the\
 source. If a file does not exist on the source, it is also <i><u>deleted</u></i>\
 from the destination."
  ),

  transfer_mode_warning_copy: T(
    "<b>COPY</b>: Files from the source are <i><u>copied</u></i> to the destination. If files with\
 the same names are present on the destination, they are <i><u>overwritten</u></i>."
  ),

  transfer_mode_warning_move: T(
    "<b>MOVE</b>: After files are <i><u>copied</u></i> from the source to the destination, they are\
 ...
 task status to see a list of transferred files.'
  ...
  encryption_password_tooltip: T(
    "Password to encrypt and decrypt remote \
 ...
 value will result in data loss.'
  ...
  cloudsync_picker_tooltip: T(
    "Select a schedule preset or choose <i>Custom</i> to open\
 the advanced scheduler."
  ...
  transfers_tooltip: T(
    'Number of simultaneous file transfers. Enter a\
 ...
 target="_blank">rclone --transfers</a>.'
  ...
  enabled_tooltip: T(
    "Enable this Cloud Sync Task. Unset to disable this Cloud\
 ...
 target="_blank">rclone --bwlimit</a>.'
  ...
  exclude_tooltip: T(
    'List of files and directories to exclude from sync.<br> \
 ...
 for more details about the <code>--exclude</code> option.'
  ...
  dry_run_dialog: T(
    "Start a dry run test of this cloud sync task? The \
