...
export default {
  ...
  mode_tooltip: T(
    "<i>AHCI</i> emulates an AHCI hard disk for better\
 ...
 installed in the VM to support VirtIO disk devices."
  ...
  sectorsize_tooltip: T(
    "Select a sector size in bytes. <i>Default</i> leaves the\
 ...
 changes both the logical and physical sector size."
  ...
  adapter_type_tooltip: T(
    "Emulating an <i>Intel e82545 (e1000)</i> Ethernet card\
 ...
 with VirtIO paravirtualized network driver support."
  ...
  mac_tooltip: T(
    "By default, the VM receives an auto-generated random\
 ...
 to add a new randomized address into this field."
  ...
  raw_file_path_tooltip: T(
    "Browse to a storage location and add the name of the\
 new raw file on the end of the path."
  ...
  mode_type_tooltip: T(
    "<i>AHCI</i> emulates an AHCI hard disk for best\
 software compatibility. <i>VirtIO</i> uses\
 paravirtualized drivers and can provide better\
 performance, but requires the operating system\
 installed in the VM to support VirtIO disk devices."
  ...
  rootpwd_tooltip: T(
    "Enter a password for the <i>rancher</i> user. This\
 is used to log in to the VM from the serial shell."
  ...
  port_tooltip: T(
    "Can be set to <i>0</i>, left empty for TrueNAS to\
 ...
 fixed, preferred port number."
  ...
  password_tooltip: T(
    "Enter a VNC password to automatically pass to the\
