...
export default {
 ...
 must be unique."),
  ...
  setup_method_tooltip: T(
    "How to configure the connection:<br><br> \
 ...
 connection."),
  ...
  private_key_tooltip: T(
    "Choose a saved SSH Keypair or select \
 ...
 connection."
  ...
  remote_host_key_tooltip: T(
    "Remote system SSH key for this system to \
