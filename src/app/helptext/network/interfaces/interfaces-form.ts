...
export default {
 ...
 interface."
  ...
  int_interface_tooltip: T(
    "Enter the FreeBSD device name of the\
 ...
 when editing an interface."
  ...
  int_dhcp_tooltip: T(
    "Set to enable DHCP. Leave unset to create a static\
 IPv4 or IPv6 configuration. Only one interface can\
 be configured for DHCP."
  ),

  int_ipv6auto_placeholder: T("Autoconfigure IPv6"),
  int_ipv6auto_tooltip: T(
    'Set to automatically configure the IPv6 address with\
 ...
 be configured this way.'
  ...
  disable_offload_capabilities_tooltip: T(
 ...
 machines."
  ...
  disable_offload_capabilities_warning_msg: T(
    "Disabling hardware offloading can severely reduce\
 ...
 address."
  ...
  alias_address6_tooltip: T(
    "Enter a static IPv6 address if DHCP is unset.\
 Example: <i>2001:0db8:85a3:0000:0000:8a2e:0370:7334</i>"
  ...
  failover_critical_tooltip: T(
    "Interfaces marked <i>critical</i> are\
 ...
 triggered."
  ...
  failover_group_tooltip: T(
    "Combine multiple, critical-for-failover \
 ...
 requires a separate VHID for each address."
  ...
  failover_alias_address_tooltip: T(
    "Alias for the identical interface \
 ...
 remains active if a Controller failover occurs."
  ...
  failover_alias_set_error: T(
    "An IP address must be provided for\
 each controller and the virtual interface."
  ...
  vlan_pint_tooltip: T(
    "Select the VLAN Parent Interface. Usually an Ethernet\
 ...
 aggregations are not available until the system is restarted."
  ...
  vlan_pcp_tooltip: T(
    "Select the Class of Service. The available 802.1p\
 ...
 to <i>Network control (highest)</i>."
  ...
  lagg_protocol_tooltip: T(
    'Determines the outgoing and incoming traffic ports.<br> \
 ...
 for more details.'
  ...
  lagg_interfaces_tooltip: T(
    "Select the interfaces to use in the aggregation.<br>\
 ...
 interfaces have been manually configured."
  ...
  mtu_tooltip: T(
    "Maximum Transmission Unit, the largest protocol data \
