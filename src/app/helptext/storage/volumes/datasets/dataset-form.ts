...
export default {
  ...
  dataset_form_sync_tooltip: T(
    "<i>Standard</i> uses the sync settings that have been\
 ...
 writes to complete."
  ...
  dataset_form_compression_tooltip: T(
    "Encode information in less space than the \
 ...
 elminates runs of zeroes."
  ...
  dataset_form_atime_tooltip: T(
    "Choose <i>ON</i> to update the access time for files\
 ...
 result in significant performance gains."
  ...
  dataset_form_share_type_tooltip: T(
    "Choose the type that matches the type of client\
 accessing the pool/dataset."
  ),

  dataset_form_refquota_placeholder: T("Quota for this dataset"),
  dataset_form_refquota_tooltip: T(
    "<i>0</i> disables quotas. Specify a maximum allowed\
 space for this dataset."
  ),

  dataset_form_refquota_warning_placeholder: T("Quota warning alert at, %"),
  dataset_form_refquota_warning_tooltip: T(
    "Apply the same quota warning \
 alert settings as the parent dataset."
  ...
  dataset_form_refquota_critical_tooltip: T(
    "Apply the same quota critical \
 alert settings as the parent dataset."
  ),
  ...
  dataset_form_quota_tooltip: T(
    "Define a maximum size for both the dataset and any child\
 datasets. Enter <i>0</i> to remove the quota."
  ...
  dataset_form_refreservation_tooltip: T(
    "<i>0</i> is unlimited. Reserve additional space for\
 ...
 both this dataset and any child datasets."
  ...
  dataset_form_deduplication_tooltip: T(
    "Transparently reuse a single copy of duplicated \
 ...
 a one-way process. <b>Deduplicated data cannot be undeduplicated!</b>."
  ...
  dataset_form_deduplication_warning: T(
  ...
  dataset_form_snapdir_tooltip: T(
    "Choose if the .zfs snapshot directory is <i>Visible</i>\
 or <i>Invisible</i> on this dataset."
  ...
  dataset_form_recordsize_tooltip: T(
    "Matching the fixed size of data, as in a database, may\
 result in better performance."
  ),
  dataset_form_warning_1: T("WARNING: Based on the pool topology, "),
  dataset_form_warning_2: T(
    " is the minimum recommended record size. Choosing a smaller size can reduce system performance."
  ),

  dataset_form_casesensitivity_placeholder: T("Case Sensitivity"),
  dataset_form_casesensitivity_tooltip: T(
    "<i>Sensitive</i> assumes filenames are case sensitive.\
 ...
 See <a href="https://zfsonlinux.org/manpages/0.7.13/man8/zpool.8.html" target="_blank">zpool(8)</a> for more details on the special allocation'
  ...
  dataset_form_encryption: {
    ...
    encryption_type_tooltip: T(
      "How the dataset is secured. Choose between securing with\
 ...
 Delete any previous key file backups and back up the new key file."
    ...
    algorithm_tooltip: T(
      'Mathematical instruction sets that determine how plaintext is converted \
     into ciphertext. See \
    ...
    passphrase_tooltip: T(
      "User-defined string used to decrypt the dataset. Can be used instead of an encryption key.<br> \
 ...
 as non-encrypted. Do you want to continue?"
  ...
  afterSubmitDialog: {
    ...
    message: T(
      "The parent of this dataset has an Access Control List (ACL). Do you want to set an ACL for this \
