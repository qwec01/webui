              ...
              (t.controllers.line = t.DatasetController.extend({
                ...
                updateElement: function (t, e, i) {
                  ...
                  void 0 !== d.radius &&
                    ...
                    (o = i
                      ? h.getBasePixel()
                      : r.calculatePointY(c, e, u, r.chart.isCombo)),
                    (t._xScale = f),
                    (t._yScale = h),
                    (t._datasetIndex = u),
                    (t._index = e),
                      ...
                      (o = s.data.datasets[n]),
                        ...
                        "line" === r.type &&
                          ...
                          (o.data[e] < 0
                            ...
                            : (c += o.data[e] || 0));
                    return 0 > t
                      ? u.getPixelForValue(h + t)
                      : u.getPixelForValue(c + t);
                  }
              ...
              (t.controllers.polarArea = t.DatasetController.extend({
                ...
                updateElement: function (t, a, i) {
                  ...
                  var x = -0.5 * Math.PI,
                    y = t.hidden
                      ? 0
                      : u.getDistanceFromCenterForValue(l.data[a]),
                    k = x + f * m,
                    S = k + (t.hidden ? 0 : f),
                    w = d.animateScale
                      ? 0
                    ...
                    if (((r.font = h), p)) {
                      ...
                      (r.textAlign = "left"),
                        ...
                        e.each(a.legendItems, function (t, e) {
                          var i =
                            n.boxWidth + d / 2 + r.measureText(t.text).width;
                    ...
                    var b = n.boxWidth,
                      ...
                      x = function (t, e, a) {
                        u.save(),
                          ...
                          u.setLineDash &&
                            u.setLineDash(c(a.lineDash, r.borderDash)),
                  ...
                  if (
                    ...
                    if (d) {
                      ...
                      var k =
                        ...
                        u * x +
                        y * x;
                      (i.height = Math.min(a.maxHeight, i.height + k)),
                        (a.ctx.font = f);
                      var S = a.ctx.measureText(a.ticks[0]).width,
                        w = a.ctx.measureText(a.ticks[a.ticks.length - 1])
                          .width,
                        C = Math.cos(e.toRadians(a.labelRotation)),
                        M = Math.sin(e.toRadians(a.labelRotation));
                      (a.paddingLeft =
                        0 !== a.labelRotation ? C * S + 3 : S / 2 + 3),
                        (a.paddingRight =
                          0 !== a.labelRotation ? M * (u / 2) + 3 : w / 2 + 3);
                    } else {
                ...
                draw: function (a) {
                  ...
                  if (n.display) {
                    ...
                    if (u.drawBorder) {
                      ...
                      g
                        ? ((H = N = "top" === n.position ? i.bottom : i.top),
                          (H += E),
                          (N += E))
              ...
              (t.elements.Line = t.Element.extend({
                ...
                draw: function () {
                  ...
                  o.save(),
                    i._children.length > 0 &&
                        ...
                        function (t, a) {
                          ...
                          0 === a
                            ? (i._loop
                              ...
                              t._view.skip
                                ? i._loop ||
                                  o.moveTo(l._view.x, i._view.scaleZero)
                      ...
                      i._loop
                        ? t(!0)
                        : (o.lineTo(
                            i._children[i._children.length - 1]._view.x,
                            n.scaleZero
                          ),
                  ...
                  (o.lineCap = n.borderCapStyle || s.borderCapStyle),
                    o.setLineDash &&
                      o.setLineDash(n.borderDash || s.borderDash),
                    (o.lineDashOffset =
                      n.borderDashOffset || s.borderDashOffset),
            ...
            var e = t.helpers,
              ...
              i = t.Scale.extend({
                determineDataLimits: function () {
                  var t = this;
                  (t.minIndex = 0),
                    (t.maxIndex = t.chart.data.labels.length - 1);
                  var a;
                ...
                buildTicks: function (t) {
                  ...
                  e.ticks =
                    0 === e.minIndex &&
                    e.maxIndex === e.chart.data.labels.length - 1
                      ? e.chart.data.labels
                ...
                getPixelForValue: function (t, e, a, i) {
                  ...
                  return (
                    n.options.gridLines.offsetGridLines && i && (c += u / 2),
                    n.top + Math.round(c)
                  );
                },
                getPixelForTick: function (t, e) {
          ...
          e.exports = function (t) {
            ...
            t.LinearScaleBase = t.Scale.extend({
              ...
              buildTicks: function () {
                ...
                var l,
                  s =
                    (i.fixedStepSize && i.fixedStepSize > 0) ||
                    (i.stepSize && i.stepSize > 0);
                ...
                getPixelForValue: function (t, a, i, n) {
                  ...
                  return (
                    l.isHorizontal()
                      ...
                      : ((o = l.height - (c + h)),
                        (r =
                          l.bottom - h - (o / u) * (e.log10(d) - e.log10(s)))),
                    r
                  );
                },
                getValueForPixel: function (t) {
                ...
                o = t.Scale.extend({
                          ...
                          function (e, i) {
                            ...
                            n.isValid() &&
                              (t.options.time.round &&
                                n.startOf(t.options.time.round),
                              a.push(n));
                          },
                          t
                        ),
                  ...
                  buildTicks: function (i) {
                    ...
                    if (
                      ...
                      for (var p = 0, m = a.units[p]; p < a.units.length; ) {
                        if (
                          ((n.unitScale = 1),
                          e.isArray(m.steps) &&
                            Math.ceil(n.scaleSizeInUnits / g) < e.max(m.steps))
                        ) {
                          for (var b = 0; b < m.steps.length; ++b)
                            if (
                              m.steps[b] >= Math.ceil(n.scaleSizeInUnits / g)
                            ) {
                              n.unitScale = e.getValueOrDefault(
                                n.options.time.unitStepSize,
                                m.steps[b]
                        ...
                        if (
                          m.maxStep === !1 ||
                          Math.ceil(n.scaleSizeInUnits / g) < m.maxStep
                        ) {
                          n.unitScale = e.getValueOrDefault(
                            n.options.time.unitStepSize,
                        ...
                        (n.scaleSizeInUnits =
                          n.lastTick.diff(n.firstTick, n.tickUnit, !0) + v + x),
                          (n.displayFormat =
                            n.options.time.displayFormats[m.name]);
                      }
                    }
                    var y;
                    if (
                        ...
                        function (t, e) {
                          for (var a = 1; a < n.labelMoments[e].length; a++)
                            n.smallestLabelSeparation = Math.min(
                              ...
                              n.labelMoments[e][a].diff(
                                n.labelMoments[e][a - 1],
                                n.tickUnit,
                                !0
                              )
                            );
                    ...
                    for (var S = 1; S <= n.scaleSizeInUnits; ++S) {
                      ...
                      if (
                        n.options.time.max &&
                        w.diff(n.lastTick, n.tickUnit, !0) >= 0
                      )
                        break;
                      S % n.unitScale === 0 && n.ticks.push(w);
                    }
                    var C = n.ticks[n.ticks.length - 1].diff(
                      n.lastTick,
                      n.tickUnit
                    );
