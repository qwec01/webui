...
export default {
  ...
  snapshot_add_name_tooltip: T(
    "Unique snapshot name. Cannot be used with \
 a <i>Naming Schema</i>."
  ),

  snapshot_add_naming_schema_placeholder: T("Naming Schema"),
  snapshot_add_naming_schema_tooltip: T(
 ...
 cloned snapshot."
  ...
  rollback_recursive_radio_tooltip: T(
    "Choose a safety level for the \
 ...
 additional snapshots that are directly related to the dataset being rolled back."
  ...
  rollback_dataset_tooltip: T(
    "Stops the rollback when the safety check \
 ...
 are newer than the rollback snapshot."
  ...
  rollback_recursive_tooltip: T(
    "Stops the rollback when the safety \
 ...
 rollback snapshot."
  ...
  rollback_recursive_clones_tooltip: T(
    "The rollback will destroy any \
 related intermediate, child dataset, and cloned snapshots that are \
 newer than the rollback snapshot."
  ),

  rollback_warning: T(
    "<b>WARNING:</b> Rolling the dataset back \
 ...
 backed up."
  ...
  extra_cols: {
    ...
    message_show: T(
      "Showing extra columns in the table is useful for data filtering, \
 but can cause performance issues. NOTE: This window will reload automatically so that the new view can take effect."
    ),
    message_hide: T(
      "Hidden columns are not available for sorting or filtering, but the values can be \
