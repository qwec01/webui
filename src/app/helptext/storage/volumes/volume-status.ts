...
export default {
  dialogFormFields: {
    disk: {
      ...
      tooltip: T(
        "Choose a new disk for the pool. To protect any existing data,\
 adding the selected disk is stopped when the disk is already in use or has partitions present."
    ...
    passphrase: {
      ...
      tooltip: T(
        "Enter the current passphrase for the encrypted pool. This will be used\
 to encrypt the new disk and integrate it into the pool."
    ...
    force: {
      placeholder: T("Force"),
      tooltip: T(
        "Set to override safety checks and add the disk to the pool. <br>WARNING:\
 any data stored on the disk will be erased!"
    ...
    new_disk: {
      ...
      tooltip: T(
        "Select an unused disk to add to this vdev. <br>WARNING: any data stored\
 on the unused disk will be erased!"
  ...
  offline_disk: {
    ...
    encryptPoolWarning: T(
      "<br><b>Warning: Disks cannot be onlined in encrypted pools.</b></br>"
    ),
    buttonMsg: T("Offline"),
  },
