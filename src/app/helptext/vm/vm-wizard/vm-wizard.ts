...
export default {
  ...
  wizard_type_options: [{ label: T("Virtual Machine (VM)"), value: "vm" }],
  ...
  bootloader_tooltip: T(
    "Select <i>UEFI</i> for newer operating systems or\
 ...
 used when the other options do not work."
  ...
  enable_display_tooltip: T(
    "Enable a Display (Virtual Network Computing) remote\
 connection. Requires <i>UEFI</i> booting."
  ),

  display_bind_placeholder: T("Bind"),
  display_bind_tooltip: T(
    "Display network interface IP address. The primary\
 ...
 restrictions on the number of CPUs."
  ...
  shutdown_timeout: {
    ...
    tooltip: T(
      "The time in seconds the system waits for the VM to cleanly shut down. \
 ...
 timeout has expired."
  ...
  memory_warning: T(
    "Caution: Allocating too much memory can slow the \
 system or prevent VMs from running."
  ),
  vm_mem_title: T("Available Memory:"),

  disks_label: T("Disks"),
  disk_radio_tooltip: T(
    "Select <i>Create new disk image</i> to create a new\
 ...
 smaller than MiB are not allowed."),
  ...
  NIC_type_tooltip: T(
    "<i>Intel e82545 (e1000)</i> emulates the same\
 ...
 paravirtualized network drivers."
  ...
  NIC_mac_tooltip: T(
    "Enter the desired address into the field to\
