  ...
  let dictionary = [
    {
      ...
      units: "%",
      labelY: "% CPU",
      analytics: { min: true, max: true, avg: true, total: true },
    },
    {
      source: "temperature",
      units: "°C",
      labelY: "Celsius",
      conversion: "decikelvinsToCelsius",
      analytics: { min: true, max: true, avg: true, total: true },
    },
    {
      source: "memory",
      ...
      labelY: "Gigabytes",
      removePrefix: "memory-",
      conversion: "bytesToGigabytes",
      analytics: { min: true, max: true, avg: true, total: false },
    },
    {
      source: "swap",
      units: "GiB",
    ...
    {
      source: "cache_ratio-arc",
      units: "%",
      labelY: "Hits",
      dataUnits: "percentage",
      conversion: "percentFloatToInteger",
      analytics: { min: true, max: true, avg: true, total: true },
    },
    {
      source: "processes",
      units: "",
      labelY: "Processes",
      removePrefix: "ps_state-",
      analytics: { min: true, max: true, avg: true, total: true },
    },
    {
      source: "cache_result-demand_data-hit",
      units: "",
      labelY: "Requests",
      analytics: { min: true, max: true, avg: true, total: true },
    },
    {
      source: "cache_result-demand_metadata-hit",
      units: "k",
      labelY: "Requests",
      analytics: { min: true, max: true, avg: true, total: true },
    },
    {
      source: "cache_result-prefetch_data-hit",
      units: "",
      labelY: "Requests",
      analytics: { min: true, max: true, avg: true, total: true },
    },
    {
      source: "cache_result-prefetch_metadata-hit",
      units: "m",
      labelY: "Requests",
      analytics: { min: true, max: true, avg: true, total: true },
    },
...
const computeValueColumnName = (source, dataSetType) => {
  ...
  if (source.startsWith("disk-")) {
    if (
      dataSetType === "disk_octets" ||
      dataSetType === "disk_ops" ||
      dataSetType === "disk_time"
    ) {
      returnVal = "read";
  ...
  for (const prop of properties) {
    if (prop.startsWith("cputemp-")) {
      ...
      configData.push({
        ...
        legends: ["read", "write"],
        dataList: [
          { source: prop, type: "disk_time", dataset: "read" },
      ...
      configData.push({
        ...
        legends: ["read", "write"],
        dataList: [
          { source: prop, type: "disk_ops", dataset: "read" },
      ...
      configData.push({
        ...
        legends: ["read", "write"],
        dataList: [
          { source: prop, type: "disk_octets", dataset: "read" },
      ...
      configData.push({
        ...
        legends: ["rx", "tx"],
        dataList: [
          { source: prop, type: "if_errors", dataset: "rx" },
      ...
      configData.push({
        ...
        legends: ["rx", "tx"],
        dataList: [
          { source: prop, type: "if_octets", dataset: "rx" },
      ...
      configData.push({
        ...
        legends: ["rx", "tx"],
        dataList: [
          { source: prop, type: "if_packets", dataset: "rx" },
      ...
      if (prop.startsWith("df-") || prop === "memory" || prop === "swap") {
        divideBy = 1073741824;
        title += " (gigabytes)";
      }
  ...
  const chartConfigData = [
    ...
    },
    {
      ...
      dataList: [
        {
          source: "zfs_arc",
          type: "cache_result-demand_data-hit",
          dataset: "value",
        },
        {
          source: "zfs_arc",
          type: "cache_result-demand_data-miss",
          dataset: "value",
        },
      ],
    },
    {
      ...
      dataList: [
        {
          source: "zfs_arc",
          type: "cache_result-demand_metadata-hit",
          dataset: "value",
        },
        {
          source: "zfs_arc",
          type: "cache_result-demand_metadata-miss",
          dataset: "value",
        },
      ],
    },
    {
      ...
      dataList: [
        {
          source: "zfs_arc",
          type: "cache_result-prefetch_data-hit",
          dataset: "value",
        },
        {
          source: "zfs_arc",
          type: "cache_result-prefetch_data-miss",
          dataset: "value",
        },
      ],
    },
    {
      ...
      dataList: [
        {
          source: "zfs_arc",
          type: "cache_result-prefetch_metadata-hit",
          dataset: "value",
        },
        {
          source: "zfs_arc",
          type: "cache_result-prefetch_metadata-miss",
          dataset: "value",
        },
      ],
    },
...
function handleDataFunc(linechartData, dataList, legends) {
  ...
  linechartData.labels.forEach((label) => {
    data.labels.push(new Date(label));
  });
  ...
  return {
    ...
    legendAnalytics: legendAnalytics,
    dataObj: data,
  };
}
...
const sourcesHandler = (res) => {
  ...
  knownCharts.forEach((item) => {
    cacheConfigData.push(item);
  });
