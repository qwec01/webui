...
export const helptext = {
  two_factor: {
    ...
    message: T(
      "Use this form to set up Two-Factor Authentication for this system. \
 ...
 on a mobile device."
    ...
    otp: {
      ...
      tooltip: T(
        "The number of digits in the One-Time Password. The default value is 6, \
 ...
 before selecting this."
    ...
    interval: {
      ...
      tooltip: T(
        "The lifespan (in seconds) of each One-Time Password. Default is 30 seconds. \
 The minimum lifetime is 5 seconds."
    ...
    window: {
      ...
      tooltip: T(
        "Use <i>Window</i> to extend the validity of passwords beyond the <i>Interval</i> setting. \
...
IMPORTANT: Two-factor authentication is time-based and requires that the system time is set correctly."
    ...
    services: {
      ...
      tooltip: T(
        "Enable two-factor authentication for SSH access to the system. It is recommended \
 to leave this DISABLED until after two-factor authentication is successfully tested with the UI."
    ...
    secret: {
      ...
      tooltip: T(
        "The secret used to generate OTPs. The secret is produced by the system when Two-Factor \
 Authentication is first activated."
    ...
    uri: {
      ...
      tooltip: T(
        "The URI used to provision an OTP. The URI (which contains the secret) is encoded in a QR Code. \
 ...
 into the app. The URI is produced by the system when Two-Factor Authentication is first activated."
    ...
    submitDialog: {
      title: T("Important"),
      message: T(
        "These settings require the reconfiguration of any existing client. \
 After saving these changes, use your device to scan the QR Code."
    ...
    confirm_dialog: {
      ...
      message: T(
        "CAUTION: Once Two-Factor Authentication is enabled, a One-Time Password (OTP) \
 will be required to sign into this system. Be sure to immediately set up another two-factor device."
    ...
    renewSecret: {
      ...
      message: T(
        "Renewing the secret will cause a new URI and a \
