...
export default {
  ...
  dataset_acl_tag_tooltip: T(
    'Access Control Entry (ACE) user or group.\
 ...
 <a href="https://www.freebsd.org/cgi/man.cgi?query=setfacl" target="_blank">setfacl(1) NFSv4 ACL ENTRIES</a>.'
  ...
  dataset_acl_type_tooltip: T(
    "How the <i>Permissions</i> are applied to\
 ...
 applies."),
  ...
  dataset_acl_uid_tooltip: T(
    "User who controls the dataset. This user\
 ...
 appear in the drop-down menu."
  ...
  apply_user: {
    ...
    tooltip: T(
      "Confirm changes to <i>User</i>. To prevent errors, changes to the <i>User</i> \
 are submitted only when this box is set."
    ),
  },

  dataset_acl_gid_placeholder: T("Group"),
  dataset_acl_gid_tooltip: T(
    "The group which controls the dataset. This\
 ...
 service appear in the drop-down menu."
  ...
  apply_group: {
    ...
    tooltip: T(
      "Confirm changes to <i>Group</i>. To prevent errors, changes to the <i>Group</i> \
 are submitted only when this box is set."
    ),
  },
  ...
  dataset_acl_perms_tooltip: T(
    "Select permissions to apply to the chosen\
 <i>Who</i>. Choices change depending on the <i>Permissions Type</i>."
  ...
  dataset_acl_basic_perms_other_warning: T(
    "These permissions are too complicated to be displayed and cannot be saved unless changed."
  ),
  ...
  dataset_acl_flags_type_tooltip: T(
    "Select the set of ACE inheritance\
 ...
 control."
  ...
  dataset_acl_flags_tooltip: T(
    "How this ACE is applied to newly created\
 ...
 make data inaccessible."
  ...
  dataset_acl_stripacl_tooltip: T(
    "Set to remove all ACLs from the current\
 ...
 datasets when those options are set."
  ...
  stripACL_dialog: {
    title: T("Strip ACLs"),
    message: T(
      "This action removes all ACLs from the current \
 ...
 can make data inaccessible until new permissions are created."
    ...
    warning: T(
      "Removes the ACL and permissions recursively \
 from all child datasets of the current dataset, including all directories and files contained within those child datasets. This can make data inaccessible until new permissions are created."
  ...
  dataset_acl_stripacl_dialog_warning_message: T(
    "Stripping the ACL resets\
 dataset permissions. This can make data inaccessible until new\
 permissions are created."
  ),

  dataset_acl_toplevel_dialog_message: T(
    "Editing top-level datasets can\
 prevent users from accessing data in child datasets."
  ...
  empty_acl_dialog: {
    title: T("Error"),
    message: T(
      "Cannot open this ACL. Check the permissions this dataset \
 has inherited from parents."
  ...
  type_dialog: {
    ...
    radio_preset_tooltip: T(
      "Choosing an entry loads a preset ACL that is \
 configured to match general permissions situations."
  ...
  preset_dialog: {
    message: T(
      "The chosen preset ACL will REPLACE the ACL currently displayed in the form \
 and delete any unsaved changes."
  ...
  save_dialog: {
    ...
    abort_message: T(
      "Clicking Continue allows TrueNAS to finish the update in the background while \
