...
export default {
 ...
 tests are configured to run.'
  ...
  smart_difference_tooltip: T(
    "Enter a number of degrees in Celsius. SMART reports if\
 ...
 Celsius since the last report."
  ...
  smart_informational_tooltip: T(
    "Enter a threshold temperature in Celsius. SMART will\
