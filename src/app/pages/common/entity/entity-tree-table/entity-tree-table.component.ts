...
export class EntityTreeTableComponent implements OnInit, AfterViewInit {
  ...
  sortData(
    sort: { active: string; direction: string; sortBy: string },
    nodes: TreeNode[]
  ): TreeNode[] {
  ...
  ngAfterViewInit() {
    this.core
      .register({ observerClass: this, eventName: "TreeTableGlobalFilter" })
  ...
  isTableOverflow() {
    ...
    if (this.table) {
      hasHorizontalScrollbar =
        this.table._elementRef.nativeElement.parentNode.parentNode.scrollWidth >
        this.table._elementRef.nativeElement.parentNode.parentNode.clientWidth;
    }
