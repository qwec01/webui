...
export default {
 ...
 snapshots."
  ...
  ssh_credentials_source_tooltip: T(
    "Select an existing SSH connection \
 ...
 connection."
  ...
  ssh_credentials_target_tooltip: T(
    "Select a saved remote system SSH \
 ...
 snapshot storage.'
  ...
  recursive_tooltip: T(
    "Set to also replicate all snapshots contained \
 ...
 the selected dataset snapshots."
  ...
  custom_snapshots_tooltip: T(
    "Replicate snapshots that have not been \
 ...
 patterns are shown.'
  ...
  transport_tooltip: T(
    "Data transfer security. The connection is \
 ...
 just once."
  ...
  schedule_tooltip: T(
    "Set specific times to snapshot the \
 ...
 <i>Custom</i> to use the advanced scheduler."
  ...
  readonly_tooltip: T(
    "Setting this option changes the destination dataset to be read-only.\
