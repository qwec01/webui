...
export default {
  ...
  uuid_tooltip: T(
    "Required. Can contain letters, numbers, periods (.), \
 ...
 of the jail."),
  ...
  jailtype_tooltip: T(
    "<i>Default (Clone Jail)</i> or <i>Basejail</i>.\
 ...
 when upgraded."
  ...
  release_tooltip: T(
    "FreeBSD release to use as the jail operating system. \
 ...
 system. Newer releases are not shown."
  ...
  dhcp_tooltip: T(
    "Set to autoconfigure jail networking with the\
 ...
 <b>Berkeley Packet Filter<b> must also be enabled."
  ...
  nat_tooltip: T(
    "Network Address Translation (NAT). Transforms local\
 ...
 target="_blank">VNET(9)</a> and shared IP jails.'
  ...
  defaultrouter_tooltip: T(
    "A valid IPv4 address to use as the default\
 ...
 any networks.</b>"
  ...
  auto_configure_ip6_tooltip: T(
    "Set to use SLAAC (Stateless Address Auto\
 ...
 target="_blank">VNET(9)</a> and shared IP jails.'
  ...
  defaultrouter6_tooltip: T(
    "A valid IPv6 address to use as the default\
 ...
 be able to access any networks.</b>"
  ...
  boot_tooltip: T(
    "Set to auto-start the jail at system boot time.\
 ...
 and <b>enforce_statfs</b> is set to a value lower than <i>2</i>.'
  ...
  exec_start_tooltip: T(
    'Commands to run in the jail environment when the\
 ...
 target="_blank">JAIL(8)</a> describes <b>exec.start</b> usage.'
  ...
  exec_stop_tooltip: T(
    "Commands to run in the jail environment before the\
 ...
 after a jail is stopped."),
  ...
  exec_clean_tooltip: T(
    "Run commands in a clean environment. The current\
 ...
 jail is removed immediately."
  ...
  exec_jail_user_tooltip: T(
    "Enter either <i>root</i> or another valid\
 <i>username</i>. Inside the jail, commands run as this user."
  ),

  exec_system_jail_user_placeholder: T("exec_system_jail_user"),
  exec_system_jail_user_tooltip: T(
    'Set to <i>1</i> to look for the\
 ...
 file.'
  ...
  exec_system_user_tooltip: T(
    "Run commands in the jail as this user. By\
 default, commands are run as the current user."
  ),

  mount_devfs_placeholder: T("mount_devfs"),
  mount_devfs_tooltip: T(
    'Mount a\
 <a href="https://www.freebsd.org/cgi/man.cgi?query=devfs"\
 ...
 directory.'
  ...
  enforce_statfs_tooltip: T(
    'Determine which information the processes in\
 ...
 mounts that point to the jail <i>chroot</i> directory to be available.'
  ...
  children_max_tooltip: T(
    'Number of child jails allowed to be created by\
 ...
 <b>console</b> function.'
  ...
  securelevel_tooltip: T(
    'The value of the jail\
 ...
 jail cannot perform any <b>sysvmsg</b> related system calls."
  ...
  sysvsem_tooltip: T(
    "Allow or deny access to SYSV IPC semaphore\
 ...
 system calls."
  ...
  sysvshm_tooltip: T(
    "Allow or deny access to SYSV IPC shared memory\
 primitives.<br> <b>Inherit</b>: All IPC objects on the system are\
 visible to the jail.<br> <b>New</b>: Only objects the jail creates\
 using the private key namespace are visible. The system and parent\
 ...
 target="_blank">sethostname(3)</a>.'
  ...
  allow_sysvipc_tooltip: T(
    "Choose whether a process in the jail has\
 ...
 <b>sysvshm</b> instead."
  ...
  allow_raw_sockets_tooltip: T(
    'Set to allow raw sockets. Utilities like\
 ...
 jail, ignoring the IP_HDRINCL flag on the socket.'
  ...
  allow_chflags_tooltip: T(
    "Set to treat jail users as privileged and\
 ...
 constraints are still enforced."
  ...
  allow_mlock_tooltip: T(
    'Enable running services that require\
 ...
 target="_blank">mlock(2)</a> in a jail.'
  ...
  allow_mount_tooltip: T(
    "Set to allow privileged users inside the jail to\
 mount and unmount filesystem types marked as jail-friendly."
  ),

  allow_mount_devfs_placeholder: T("allow_mount_devfs"),
  allow_mount_devfs_tooltip: T(
    "Set to allow privileged users inside the\
 ...
 the ZFS filesystem to operate from within a jail.'
  ...
  allow_vmm_tooltip: T(
    'Allow the jail to access the bhyve virtual machine\
 ...
 kernel module loaded.'
  ...
  allow_quotas_tooltip: T(
    "Set to allow the jail root to administer quotas\
 ...
 other jails or with non-jailed parts of the system."
  ...
  allow_socket_af_tooltip: T(
    "Set to allow access to other protocol stacks\
 ...
 functionality does not exist for all protocol stacks."
  ...
  vnet_interfaces_tooltip: T(
    "A space-delimited list of network interfaces\
 ...
 are automatically released when the jail is removed."
  ...
  interfaces_tooltip: T(
    "Enter up to four interface configurations in the\
 ...
 target="_blank">FIB</a>) to use when running commands inside the jail.'
  ...
  ip4_saddrsel_tooltip: T(
    "Disable IPv4 source address selection for \
 ...
 Only available when the jail is not configured to use VNET."
  ...
  ip4_tooltip: T(
    "Control the availability of IPv4 addresses.<br>\
 ...
 Stop the jail from using IPv4 entirely."
  ...
  ip6_saddrsel_tooltip: T(
    "Disable IPv6 source address selection for \
 ...
 Only available when the jail is not configured to use VNET."
  ...
  ip6_tooltip: T(
    "Control the availability of IPv6 addresses.<br>\
 <b>Inherit</b>: Allow unrestricted access to all system addresses.<br>\
 ...
 Stop the jail from using IPv6 entirely."
  ...
  resolver_tooltip: T(
    "Add lines to the jail <i>resolv.conf</i>.\
 ...
 <b>Example:</b> <i>E4F4C6</i>"),
  ...
  nat_interface_tooltip: T(
    "System network interface that remaps jail \
 ...
 interface to use for NAT."
  ...
  nat_forwards_tooltip: T(
    "Configure the ports that allow remote access to \
 ...
 duplicate plugins."
  ...
  protocol_tooltip: T(
    'The type of connection the port uses. Choose \
 ...
 for an unreliable and unordered one-way data transmission.'
  ...
  jail_port_tooltip: T(
    'Port to assign to this jail. Avoid using a port \
 ...
 target="_blank">Internet Assigned Numbers Authority (IANA) registry</a>.'
  ...
  host_port_tooltip: T(
    'The port on the host system that forwards data to \
 ...
 target="_blank">Internet Assigned Numbers Authority (IANA) registry</a>.'
  ...
  vnet_default_interface_tooltip: T(
    "Set the default VNET interface. Only\
 ...
 Choose <i>none</i> to not set a default VNET interface."
  ...
  vnet0_mac_tooltip: T(
    "Leave this field empty to generate random MAC\
 ...
 address to be assigned to the jail."
  ...
  priority_tooltip: T(
    "Numeric start priority for the jail at boot time.\
 ...
 <br> <b>Example:</b> <i>99</i>"
  ...
  hostid_tooltip: T(
    "A new jail hostid, if desired.<br>\
 <b>Example hostid:</b> <i>1a2bc345-678d-90e1-23fa-4b56c78901de</i>."
  ...
  hostid_strict_check_tooltip: T(
    "Check the <i>hostid</i> property of the\
 ...
 jail and host."),
  ...
  jail_zfs_tooltip: T(
    "Set to enable automatic ZFS jailing inside the\
 jail. The assigned ZFS dataset is fully controlled by the jail."
  ),

  jail_zfs_dataset_placeholder: T("jail_zfs_dataset"),
  jail_zfs_dataset_tooltip: T(
    "Define the dataset to be jailed and fully\
 ...
 pool name. <b>jail_zfs</b> must be set for this option to work."
  ...
  jail_zfs_mountpoint_tooltip: T(
    "Enter the mountpoint for the\
 ...
 <i>/data example-dataset-name</i>"
  ...
  allow_tun_tooltip: T(
    "Reveal <i>tun</i> devices for the jail with an\
 ...
 routers.'
  ...
  ip_hostname_tooltip: T(
    'Set to use DNS records during jail IP\
 ...
 <a href="https://www.freebsd.org/cgi/man.cgi?query=jail" target="_blank">jail(8)</a>.'
  ...
  assign_localhost_tooltip: T(
    "Set to add network interface <i>lo0</i> to\
 ...
 stack."
  ...
  memoryuse_tooltip: T(
    'Resident set size in bytes. See\
 ...
 target="_blank">RCTL(8)</a> for more details.'
  ...
  cpuset_tooltip: T(
    "Jail CPU affinity. Options are <i>off</i> or a\
 ...
 <i>1,2,3,4</i>"
  ...
  rlimits_tooltip: T(
    'Set resource limitations of the jail using the\
 ...
 target="_blank">getrlimit(2)</a> utility.'
  ...
  cputime_tooltip: T(
    "Maximum amount of CPU time a jail process may\
 ...
 jail."),
  ...
  nsemop_tooltip: T(
    'Number of SysV semaphores modified in a single\
