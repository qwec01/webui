...
export default {
 ...
 webhook settings.'
  ...
  Mattermost_icon_url_tooltip: T(
    'Icon file to use as the profile \
 ...
 integration, Settings, and read the API Key field.'
  ...
  OpsGenie_api_url_tooltip: T(
    'Leave empty for default (<a href="https://api.opsgenie.com" target="_blank">OpsGenie API</a>)'
  ),

  PagerDuty_service_key_placeholder: T("Service Key"),
  PagerDuty_service_key_tooltip: T(
    'Enter or paste the "integration/service" key for this\
 ...
 target="_blank">User-based Security Model (USM)</a> user.'
  ...
  SNMPTrap_v3_authkey_tooltip: T(
    'Initial secret authentication key. \
 ...
 Must be at least 8 and at most 32 octets long.'
  ...
  SNMPTrap_v3_authprotocol_tooltip: T(
    '<a href="https://en.wikipedia.org/wiki/Authentication_protocol" \
 ...
 messages sent on behalf of the specified <i>Username</i>.'
  ...
  SNMPTrap_v3_privprotocol_tooltip: T(
    '<a href="https://en.wikipedia.org/wiki/Cryptographic_protocol" \
 ...
 target="_blank">What is an SNMP Community String?</a>.'
  ...
  Telegram_bot_token_tooltip: T(
    'Telegram Bot API Token (<a href="https://core.telegram.org/bots#3-how-do-i-create-a-bot"\
 target="_blank">How to create a Telegram Bot</a>)'
  ),

  Telegram_chat_ids_placeholder: T("List of chat IDs"),
  Telegram_chat_ids_tooltip: T(
    'Enter a list of chat IDs separated by space, comma or semicolon. \
 ...
 target="_blank">VictorOps API key</a>.'
  ...
  VictorOps_routing_key_tooltip: T(
    'Enter or paste the <a\
