...
export class BackupCredentialsComponent implements OnInit, OnDestroy {
  ...
  refreshForms() {
    this.sshConnections = new SshConnectionsFormComponent(
      this.aroute,
    ...
    this.sshKeypairs = new SshKeypairsFormComponent(
      this.aroute,
      this.ws,
      this.loader,
      this.dialogService,
    ...
    this.cloudCredentials = new CloudCredentialsFormComponent(
      this.router,
      this.aroute,
      this.ws,
