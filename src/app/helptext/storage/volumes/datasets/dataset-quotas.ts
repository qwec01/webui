...
export default {
  users: {
    ...
    system_select: {
      ...
      tooltip: T(
        "The list only shows users cached on this system. The search box \
 ...
 Entering <code>0</code> (zero) allows all disk space to be used."
    ...
    obj_quota: {
      ...
      tooltip: T(
        "Number of objects that can be owned by each of the selected users. \
 Entering <code>0</code> (zero) allows unlimited objects."
  ...
  groups: {
    ...
    system_select: {
      ...
      tooltip: T(
        "The list shows only groups cached on this system. The search box \
  below can locate all groups, including groups connected with Active Directory or other services."
    ...
    search: {
      ...
      tooltip: T(
        "Search for all connected groups. \
 ...
 Entering <code>0</code> (zero) allows all disk space."
    ...
    obj_quota: {
      ...
      tooltip: T(
        "Number of objects that can be owned by each of the selected groups. \
 Entering <code>0</code> (zero) allows unlimited objects."
      ),
    },
    filter_dialog: {
