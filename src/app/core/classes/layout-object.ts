...
export class LayoutObject {
  ...
  public insert(item: DisplayObject, at?: number) {
    // Add new item to collection and regenerate screenPositions
  ...
  private remove(item: DisplayObject) {
    // Remove item from collection and regenerate screenPositions
    // update collection
  ...
  public beginInteractiveMovement(displayObject: DisplayObject) {
    // Do collision detection and reorder collection list
  ...
  private updateInteractiveMovement(dragTarget, newCollection, index) {
    // React to new order while in dragging
    this.reorderedCollection = newCollection;
  }

  public endInteractiveMovement(dragTarget: DisplayObject) {
  ...
  private cancelInteractiveMovement() {
  ...
  private createGrid() {
    ...
    this.createScreenPositions(
      this.orderedCollection.length,
      this.orderedCollection.length,
      this.margin,
      true
    );
  ...
  private updateCollectionPositions(
    startIndex: number,
    endIndex: number,
    dragTarget?: DisplayObject
  ) {
