...
export default {
  ...
  activedirectory_domainname_tooltip: T(
    "Enter the Active Directory domain (<i>example.com</i>)\
 or child domain (<i>sales.example.com</i>)."
  ...
  activedirectory_bindpw_tooltip: T(
 ...
 is not needed to edit, start, or stop the service."
  ...
  activedirectory_verbose_logging_tooltip: T(
    "Set to log attempts to join the domain to\
 /var/log/messages."
  ),

  activedirectory_trusted_doms_name: "allow_trusted_doms",
  activedirectory_trusted_doms_placeholder: T("Allow Trusted Domains"),
  activedirectory_trusted_doms_tooltip: T(
    "When set, usernames do not include a domain name.\
 ...
 more than one domain."
  ...
  activedirectory_default_dom_tooltip: T(
    "Unset to prepend the domain name to the username.\
 ...
 username."
  ...
  activedirectory_dns_updates_tooltip: T(
  ...
  activedirectory_disable_fn_cache_tooltip: T(
    "Set to disable caching AD users and groups. This can\
 help when unable to bind to a domain with a large number of users or groups."
  ...
  restrict_pam: {
    ...
    tooltip: T(
      "Set to restrict SSH access in certain circumstances to only members of \
 BUILTIN\\Administrators"
  ...
  activedirectory_site_tooltip: T(
    "Enter the relative distinguished name of the\
 site object in the Active Directory."
  ...
  activedirectory_kerberos_realm_tooltip: T(
    "Select an existing realm that was added \
 in <b>Directory Services > Kerberos Realms</b>."
  ...
  activedirectory_kerberos_principal_tooltip: T(
    "Select the location of the principal in the \
 keytab created in <b>Directory Services > Kerberos Keytabs</b>."
  ...
  computer_account_OU_tooltip: T(
    'The OU in which new computer accounts are created. \
 ...
 default OU.'
  ...
  activedirectory_timeout_tooltip: T(
    "Number of seconds before timeout. To view the AD \
 connection status, open the interface <i>Task Manager</i>."
  ...
  activedirectory_dns_timeout_tooltip: T(
    "Number of seconds before a timeout. Increase this\
 value if AD DNS queries time out."
  ...
  activedirectory_idmap_backend_tooltip: T(
    "Choose the backend to map Windows security\
 identifiers (SIDs) to UNIX UIDs and GIDs. Click Edit to configure that backend."
  ...
  activedirectory_nss_info_tooltip: T(
    "Choose the schema to use when querying AD for\
 ...
 The first time this option is set, the Domain Account Password must be entered."
  ...
  activedirectory_netbiosname_a_tooltip: T(
 ...
 the <i>Workgroup</i> name and be no greater than 15 characters."
  ...
  activedirectory_netbiosalias_tooltip: T(
    "Alternative names that SMB clients can use when\
