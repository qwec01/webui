...
export default {
  ...
  VMware_snapshot_form_hostname_tooltip: T(
    "Enter the IP address or hostname of the VMware host.\
 When clustering, this is the vCenter server for the cluster."
  ...
  VMware_snapshot_form_username_tooltip: T(
    "Enter the user on the VMware host with permission to\
 snapshot virtual machines."
  ...
  VMware_snapshot_form_datastore_tooltip: T(
    "After entering the <b>Hostname, Username</b>, and\
