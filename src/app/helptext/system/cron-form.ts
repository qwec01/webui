...
export default {
  ...
  cron_command_tooltip: T(
    "Enter the full path to the command or script to\
                be run."
  ),

  cron_user_placeholder: T("Run As User"),
  cron_user_tooltip: T(
    "Select a user account to run the command. The\
 ...
 complete."
  ...
  cron_stdout_tooltip: T(
    "Hide standard output (stdout) from the command.\
  ...
  cron_stderr_tooltip: T(
    "Hide error output (stderr) from the command.\
                When unset, any error output is mailed to the user\
                account cron used to run the command."
  ),

  cron_enabled_placeholder: T("Enabled"),
  cron_enabled_tooltip: T(
    "Enable this cron job. When unset, disable the\
