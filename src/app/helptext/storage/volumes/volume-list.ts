...
export default {
  ...
  unlockDialog_recovery_key_tooltip: T(
    "Unlock the pool with a recovery \
 ...
 from the local system."
  ...
  exportDialog: {
    ...
    warningSysDataset: T(
      "This pool contains the system dataset that stores critical data like debugging \
...
the system dataset transfers back to the TrueNAS operating system device."
 ...
 Back up critical data <b>before</b> exporting/disconnecting the pool."
    ...
    unknownStateB: T(
      "</i>is in the database but not connected to the machine. If it was exported by \
    mistake, reconnect the hardware and use <b>Import Pool</b>.<br /><br />"
    ),
    encryptWarning: T(
      "' is encrypted! If the passphrase for\
 ...
 store the encryption key and any passphrase for it."
  ...
  upgradePoolDialog_warning: T(
    "Proceed with upgrading the pool? WARNING: Upgrading a pool is a\
 ...
 the pool incompatible with older versions of TrueNAS: "
  ...
  pool_lock_warning_paratext_b: T(
    "</i>.\
 Data on the pool will not be accessible until the pool is unlocked."
  ...
  permissions_edit_msg2: T(
    "This dataset has an active ACL. Changes to permissions must be made with the ACL editor."
  ),
  ...
  pool_options_dialog: {
    ...
    autotrim_tooltip: T(
      "Enable for TrueNAS to periodically review data blocks and identify\
