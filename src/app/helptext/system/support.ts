...
export const helptext_system_support = {
  proactive: {
    ...
    instructions: T(
      "Silver / Gold Coverage Customers can enable iXsystems Proactive Support. This \
 ...
 replicate the issue."
  ...
  core_upgrade_license: {
    ...
    dialog_msg: T(
      "To update the current software license or upgrade from TrueNAS Core® to TrueNAS \
 Enterprise®, copy the text of the TrueNAS license and paste it in this box."
  ...
  is_production_checkbox: {
    ...
    tooltip: T(
      "Set system production state and optionally send initial debug."
    ),
  },
  ...
  FN_Jira_message: T(
    '<a href="https://jira.ixsystems.com/secure/Signup!default.jspa" target="_blank" class="native-link">\
  ...
  docHub: T(
    '<a href="https://www.truenas.com/docs/hub/" target="_blank">\
 TrueNAS Documentation Hub</a> - Read and contribute to the open-source documentation.'
  ),

  forums: T(
    '<a href="https://www.ixsystems.com/community/" target="_blank">\
 TrueNAS Forums</a> - Find answers from other users in the forums.'
  ),

  licensing: T(
    '<a href="https://www.ixsystems.com/support/" target="_blank">\
