...
export default {
  ...
  hostname_virtual_tooltip: T(
    "When using a virtual host, this is also \
 used as the Kerberos principal name."
  ...
  domains_tooltip: T(
    "Additional domains to search. Separate entries by \
 pressing <code>Enter</code>. Adding search domains can cause slow DNS \
 lookups."
  ),

  ipv4gateway_placeholder: T("IPv4 Default Gateway"),
  ipv4gateway_tooltip: T(
    "Enter an IPv4 address. This overrides the default\
 gateway provided by DHCP."
  ),

  ipv6gateway_placeholder: T("IPv6 Default Gateway"),
  ipv6gateway_tooltip: T(
    "Enter an IPv6 address. This overrides the default\
 gateway provided by DHCP."
  ),
  ...
  httpproxy_tooltip: T(
    "When using a proxy, enter the proxy information for \
 ...
 the default gateway.'
  ...
  hosts_tooltip: T(
    'Additional hosts to be appended to <i>/etc/hosts</i>.\
 ...
 for additional information.'
  ...
  netbios_tooltip: T(
    "Legacy NetBIOS name server. Advertises the SMB \
 ...
 <i>Network Neighborhood</i>)."
  ...
  mdns_tooltip: T(
    "Multicast DNS. Uses the system <i>Hostname</i> to \
 ...
 the server appears under <i>Network</i> on MacOS clients."
  ...
  wsd_tooltip: T(
    "Uses the SMB Service <i>NetBIOS Name</i> to advertise \
 ...
 the <i>Network Neighborhood</i> of modern Windows OSes."
  ...
  outbound_network_activity: {
    ...
    specific: {
      ...
      tooltip: T(
        "Define the system services that are allowed to \
