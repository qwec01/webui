...
export default {
  ...
  updateRunning_dialog: {
    ...
    message: T(
      "A system update is in progress. It might have been \
 launched in another window or by an external source like TrueCommand."
  ...
  signupDialog: {
    ...
    content: T(
      "This allows your TrueNAS system to be monitored and administrated by\
 TrueCommand. Click <b>SIGNUP</b> to create a new TrueCommand Cloud instance or <b>CONNECT</b> to join an existing instance."
  ...
  updateDialog: {
    ...
    api_tooltip: T(
      'Enter or paste the API key provided from \
...
address. Please verify the email address before continuing."
  ...
  changePasswordDialog: {
    ...
    pw_new_pw_tooltip: T(
      "Passwords cannot contain a <b>?</b>. Passwords should \
