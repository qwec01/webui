...
export default {
  ...
  provider_tooltip: T(
    "Several providers are supported. If a specific \
 ...
 <b>CheckIP Server</b>."),
  ...
  checkip_server_tooltip: T(
    'Name and port of the server that reports the \
 ...
 to discover the remote socket IP address.'
  ...
  checkip_path_tooltip: T(
    "Path to the <b>CheckIP Server</b>. For example, \
 ...
 <a href="https://github.com/troglobit/inadyn#custom-ddns-providers" target="_blank">In-A-Dyn documentation</a>.'
  ...
  domain_tooltip: T(
    "Fully qualified domain name of the host with the \
