...
export class CertificateEditComponent {
  ...
  setForm() {
    ...
    _.find(this.fieldConfig, {
      name: "san",
    }).paraText += this.incomingData.san.join(",");
  ...
  exportCertificate() {
    const path = this.incomingData.CSR
    ...
    if (this.incomingData.CSR) {
      this.dialog
        .confirm(
          ...
          this.incomingData.CSR,
          true,
          helptext_system_certificates.viewDialog.download,
          false,
          "",
          "",
          "",
          "",
          false,
          helptext_system_certificates.viewDialog.close,
          false,
          this.incomingData.CSR,
          true
        )
