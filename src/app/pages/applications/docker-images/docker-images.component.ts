...
export class DockerImagesComponent implements OnInit, OnDestroy {
  ...
  public columns: Array<any> = [
    {
      name: helptext.dockerImages.columns.id,
      prop: "id",
      always_display: true,
    },
    {
      name: helptext.dockerImages.columns.tags,
      prop: "repo_tags",
      always_display: true,
    },
    {
      name: helptext.dockerImages.columns.state,
      prop: "state",
      always_display: true,
    },
  ];
  ...
  refreshUserForm() {
    this.addComponent = new PullImageFormComponent(
      this.mdDialog,
      this.dialogService,
      this.modalService
    );
  ...
  updateImage(entityDialog: any) {
    ...
    self.dialogRef = self.mdDialog.open(EntityJobComponent, {
      data: { title: helptext.dockerImages.pulling },
      disableClose: true,
    });
