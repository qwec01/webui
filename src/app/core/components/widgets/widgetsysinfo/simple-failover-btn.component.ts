...
@Component({
  ...
  template: `<button
    mat-button
    style="opacity:1; background-color: var(--primary) !important; color: var(--primary-txt) !important;"
    [color]="color"
    [disabled]="disabled"
    (click)="openDialog()"
    ix-auto
    ix-auto-type="button"
    ix-auto-identifier="Initiate Failover"
  >
    Initiate Failover
  </button>`,
})
  ...
  template: `
    ...
    <div mat-dialog-actions fxLayout="row wrap">
      <mat-checkbox
        ...
        >{{ checkbox | translate }}</mat-checkbox
      >
      <button
        fxFlex="calc(45% - 40px)"
        fxFlex.xs="45"
