...
export class InteractionManagerService {
  ...
  constructor(messageBus: CoreService) {
    ...
    messageBus
      .register({ observerClass: this, eventName: "RegisterLayout" })
    ...
    messageBus
      .register({ observerClass: this, eventName: "RegisterAsDisplayObject" })
      .subscribe((evt: CoreEvent) => {
        console.log(evt);
    ...
    messageBus
      .register({
        observerClass: this,
        eventName: "RequestDisplayObjectReference",
      })
      .subscribe((evt: CoreEvent) => {
    ...
    messageBus
      .register({ observerClass: this, eventName: "InsertIntoLayout" })
      .subscribe((evt: CoreEvent) => {
        ...
        if (!layout) {
          console.warn(
            "Cannot add element to layout. No layout with that id found. Make sure your layout exists and is registered."
          );
        } else {
    ...
    messageBus
      .register({ observerClass: this, eventName: "DisplayObjectReleased" })
      .subscribe((evt: CoreEvent) => {
  ...
  registerElement(config, layout?: LayoutObject) {
    ...
    let registration: DisplayObjectRegistration = {
      displayObject: tracker,
  ...
  getLayoutParent(displayObject: DisplayObject): LayoutObject {
    ...
    const registration: DisplayObjectRegistration[] = this.displayList.filter(
      (item) => item.displayObject == displayObject
    );
