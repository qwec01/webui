...
export class PageTitleComponent implements OnInit, AfterViewInit, OnDestroy {
  @ViewChild("viewcontroller", { static: false })
  viewcontroller: ViewControllerComponent;
  ...
  ngOnInit() {
    ...
    this.core
      .register({ observerClass: this, eventName: "PseudoRouteChange" })
    ...
    this.core
      .register({ observerClass: this, eventName: "GlobalActions" })
      .subscribe((evt: CoreEvent) => {
  ...
  createAction() {
    this.viewcontroller.layoutContainer = {
      layout: "row",
      align: "end center",
      gap: "2px",
    };
