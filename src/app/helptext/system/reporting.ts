...
export const helptext = {
  ...
  cpu_in_percentage_tooltip: T(
    "When set, report CPU usage in percent \
 ...
 <a href="http://graphiteapp.org/" target="_blank">Graphite</a> server.'
  ...
  graph_age_tooltip: T(
    "Maximum time a graph is stored in months (allowed values are 1-60). \
 ...
 reporting database is destroyed."
  ...
  graph_points_tooltip: T(
    "Number of points for each hourly, daily, \
