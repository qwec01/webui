...
export class ConsolePanelModalDialog {
  ...
  @ViewChild("footerBarScroll", { static: true })
  private footerBarScroll: ElementRef;
  ...
  getLogConsoleMsg() {
    this.intervalPing = setInterval(() => {
      ...
      if (
        this.footerBarScroll.nativeElement.scrollTop +
          this.footerBarScroll.nativeElement.offsetHeight +
          delta >=
        this.footerBarScroll.nativeElement.scrollHeight
      ) {
        isScrollBottom = true;
      }
