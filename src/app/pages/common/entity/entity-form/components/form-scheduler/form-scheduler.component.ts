...
export class FormSchedulerComponent
  ...
  @ViewChild("preview", { static: false, read: ElementRef })
  schedulePreview: ElementRef;
  ...
  private generateSchedule(nextSubset?: boolean) {
    ...
    if (!nextSubset) {
      ...
      setTimeout(() => {
        this.updateCalendar(daySchedule);
      }, 500);
    }
