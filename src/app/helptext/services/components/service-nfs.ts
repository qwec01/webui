...
export default {
  ...
  nfs_srv_servers_tooltip: T(
    "Specify how many servers to create. Increase if NFS\
 ...
 kern.smp.cpus</b> to limit CPU context switching."
  ...
  nfs_srv_bindip_tooltip: T(
    "Select IP addresses to listen to for NFS requests.\
 Leave empty for NFS to listen to all available addresses."
  ),

  nfs_srv_allow_nonroot_placeholder: T("Allow non-root mount"),
  nfs_srv_allow_nonroot_tooltip: T(
    "Set only if required by the NFS client. Set to allow\
 serving non-root mount requests."
  ...
  nfs_srv_v4_v3owner_tooltip: T(
    "Set when NFSv4 ACL support is needed without requiring\
 the client and the server to sync users and groups."
  ...
  nfs_srv_v4_krb_tooltip: T(
    "Set to force NFS shares to fail if the Kerberos ticket\
 is unavailable."
  ),

  nfs_srv_mountd_port_placeholder: T("mountd(8) bind port"),
  nfs_srv_mountd_port_tooltip: T(
 ...
 target="_blank">mountd(8)</a>.'
  ...
  nfs_srv_rpcstatd_port_tooltip: T(
    'Enter a port to bind <a\
 ...
 target="_blank">rpc.statd(8)</a>.'
  ...
  nfs_srv_rpclockd_port_tooltip: T(
    'Enter a port to bind <a\
 ...
 target="_blank">rpc.lockd(8)</a>.'
  ...
  nfs_srv_16_tooltip: T(
    "Set when a user is a member of more than 16 groups.\
 ...
 target="_blank">mountd(8)</a> syslog requests.'
  ...
  nfs_srv_statd_lockd_log_tooltip: T(
    'Set to log <a\
 href="https://www.freebsd.org/cgi/man.cgi?query=rpc.statd"\
