...
export default {
  ...
  dataset_permissions_acl_tooltip: T(
    "Select the type that matches the type of client\
 accessing the dataset."
  ),

  dataset_permissions_user_placeholder: T("User"),
  dataset_permissions_user_tooltip: T(
    "Select the user to control the dataset. Users\
...
are submitted only when this box is set."
  ...
  dataset_permissions_group_tooltip: T(
    "Select the group to control the dataset. Groups\
 created manually or imported from a directory service\
 appear in the drop-down menu."
  ),
...
are submitted only when this box is set."
  ...
  dataset_permissions_mode_tooltip: T(
  ...
  dataset_permissions_recursive_tooltip: T(
    "Apply permissions recursively to all directories\
 ...
 datasets of the current dataset."
  ...
  dataset_permissions_dialog_warning_message: T(
    "Changing dataset permission mode can severely\
