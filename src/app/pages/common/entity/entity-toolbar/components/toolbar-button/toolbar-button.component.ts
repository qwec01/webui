...
@Component({
  ...
  template: `
    <div class="toolbar-button" [class.has-tooltip]="config.tooltip">
      <button
        ix-auto
        ix-auto-type="button"
        [ix-auto-identifier]="id + '_entity_toolbar_' + config.label"
        (click)="onClick(true)"
      ...
      <tooltip
        *ngIf="config.tooltip"
        ...
        [position]="config.tooltipPosition ? config.tooltipPosition : left"
      ></tooltip>
    </div>
  `,
})
