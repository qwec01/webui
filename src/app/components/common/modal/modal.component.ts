      ...
      <div class="jw-modal-body">
        <div class="slidein-title-bar" fxLayout="row">
          <div fxFlex="90%" fxLayout="row" fxLayoutAlign="start center">
            ...
            <div
              style="color:var(--fg2);"
              *ngIf="conf && conf.titleBarControls"
              class="control-group"
              fxLayout="row"
        ...
        <ng-container *ngIf="!wizard; else wizardBlock">
          <ng-container
            *ngIf="
              (formOpen && conf && !conf.formType) ||
              (formOpen && conf && conf.formType == 'EntityFormComponent')
            "
          >
            <entity-form
              *ngIf="conf.fieldSets"
          ...
          >
            <entity-form-embedded
              *ngIf="conf.fieldSets && conf.target && conf.data"
              [target]="conf.target"
              [data]="conf.values"
              [conf]="conf"
              class="slidein-entity-form"
