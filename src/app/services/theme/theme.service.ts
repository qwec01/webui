...
export class ThemeService {
  ...
  constructor(
    ...
    this.core
      .register({ observerClass: this, eventName: "ThemeDataRequest" })
      .subscribe((evt: CoreEvent) => {
        this.core.emit({
          name: "ThemeData",
          data: this.findTheme(this.activeTheme),
          sender: this,
        });
      });
    ...
    this.core
      .register({ observerClass: this, eventName: "ThemeChangeRequest" })
      .subscribe((evt: CoreEvent) => {
    ...
    this.core
      .register({ observerClass: this, eventName: "GlobalPreviewChanged" })
      .subscribe((evt: CoreEvent) => {
        if (evt.data) {
