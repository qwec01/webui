...
export default {
  ...
  krbrealm_form_admin_server_tooltip: T(
  ...
  krbrealm_form_kpasswd_server_tooltip: T(
    "Define the server where all password changes are performed."
  ),

  krbrealm_form_advanced_field_array: ["kdc", "admin_server", "kpasswd_server"],
