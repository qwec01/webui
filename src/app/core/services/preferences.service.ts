...
export class PreferencesService {
  ...
  constructor(
    ...
    this.core
      .register({ observerClass: this, eventName: "UserPreferencesRequest" })
      .subscribe((evt: CoreEvent) => {
        ...
        if (!evt.data) {
          ...
          if (this.debug) {
            console.warn("Multiple users not supported by middleware");
          }
        }
      });
    ...
    this.core
      .register({
        observerClass: this,
        eventName: "ChangeThemePreference",
        sender: this.themeService,
      })
      .subscribe((evt: CoreEvent) => {
    ...
    this.core
      .register({
        observerClass: this,
        eventName: "ChangeCustomThemesPreference",
      })
      .subscribe((evt: CoreEvent) => {
    ...
    this.core
      .register({
        observerClass: this,
        eventName: "ReplaceCustomThemePreference",
      })
      .subscribe((evt: CoreEvent) => {
        let oldTheme: Theme;
    ...
    this.core
      .register({ observerClass: this, eventName: "ResetPreferences" })
      .subscribe((evt: CoreEvent) => {
    ...
    this.core
      .register({ observerClass: this, eventName: "ChangePreferences" })
      .subscribe((evt: CoreEvent) => {
    ...
    this.core
      .register({ observerClass: this, eventName: "ChangePreference" })
      .subscribe((evt: CoreEvent) => {
  ...
  savePreferences(data?: UserPreferences) {
    ...
    if (this.debug) {
      console.log({ SavingPreferences: this.preferences });
    }
  }
  ...
  sanityCheck(data: UserPreferences): PropertyReport {
    ...
    if (this.debug && oldKeys.length > 0)
      console.log(oldKeys.length + " Deprecated Preferences Found!");
