...
export const routes: Routes = [
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            data: {
              ...
              breadcrumb: T("Boot Environments"),
            },
          },
          {
            path: "clone/:pk",
      ...
      },
      {
        path: "alertservice",
        data: {
          title: T("Alert Services"),
          breadcrumb: T("Alert Services"),
          icon: "notifications",
        },
        children: [
          {
          ...
          },
          {
            ...
            data: {
              title: T("Add Alert Service"),
              breadcrumb: T("Add Alert Service"),
            },
          },
          {
            path: "edit/:pk",
            component: AlertServiceComponent,
            data: {
              title: T("Edit Alert Service"),
              breadcrumb: T("Edit Alert Service"),
            },
          },
        ],
      },
      ...
      },
      {
        ...
        data: {
          ...
          breadcrumb: "Init/Shutdown Scripts",
          icon: "event_note",
        },
        children: [
          {
