...
export default {
  ...
  zvol_name_tooltip: T(
    "Keep the zvol name short. Using a zvol name longer\
 than 63 characters can prevent accessing the zvol as a device."
  ...
  zvol_forcesize_tooltip: T(
    "The system restricts creating a zvol that brings the\
 ...
 the zvol (<b>NOT Recommended</b>)."
  ...
  zvol_sync_tooltip: T(
    "Sets the data write synchronization. <i>Inherit</i>\
 ...
 <b>Caution:</b> writes can fail when the pool is low on space.'
  ...
  zvol_volblocksize_tooltip: T(
    "The zvol default block size is automatically chosen\
 based on the number of the disks in the pool for a\
 general use case."
  ),

  zvol_volsize_zero_error: T("Volume size cannot be zero."),
  zvol_volsize_shrink_error: T(
