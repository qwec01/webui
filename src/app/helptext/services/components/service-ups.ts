...
export default {
 ...
 period, comma, hyphen, and underscore characters."
  ...
  ups_remotehost_tooltip: T(
    "IP address of the remote system with <i>UPS Mode</i>\
 ...
 the format <i>192.168.0.1</i>."
  ...
  ups_remoteport_tooltip: T(
    " When the <b>UPS Mode</b> is set to \
...
<i>Master</i> system. The default port is <i>3493</i>."
 ...
 list</a> for a list of supported UPS devices.'
  ...
  ups_port_tooltip: T(
    "Serial or USB port connected to the UPS. To \
 ...
 target="_blank">UPSD.CONF(5)</a>.'
  ...
  ups_shutdowntimer_tooltip: T(
    "Enter a value in seconds for the the UPS to wait\
 ...
 mode</b> is set to <i>UPS goes on battery</i>."
  ...
  ups_shutdowncmd_tooltip: T(
    "Enter a command to shut down the system when either\
 battery power is low or the shutdown timer ends."
  ),

  ups_nocommwarntime_placeholder: T("No Communication Warning Time"),
  ups_nocommwarntime_tooltip: T(
    "Enter a number of seconds to wait before alerting that\
 ...
 until the situation is fixed."
  ...
  ups_monuser_tooltip: T(
    "Enter a user to associate with this service. Keeping\
 the default is recommended."
  ),
  ups_monuser_validation: [Validators.required],

  ups_monpwd_placeholder: T("Monitor Password"),
  ups_monpwd_tooltip: T(
    "Change the default password to improve system\
 ...
 space or <b>#</b>."
  ...
  ups_extrausers_tooltip: T(
    'Enter accounts that have administrative access.\
 See <a\
 ...
 target="_blank">upsd.users(5)</a> for examples.'
  ...
  ups_rmonitor_tooltip: T(
    "Set for the default configuration to listen on all\
 ...
 <i>upsmon</i> and password: <i>fixmepass</i>."
  ...
  ups_emailnotify_tooltip: T(
    "Set enable sending messages to the address defined in\
 the <b>Email</b> field."
  ),

  ups_toemail_placeholder: T("Email"),
  ups_toemail_tooltip: T(
    "Enter any email addresses to receive status updates.\
