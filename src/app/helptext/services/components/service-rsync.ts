...
export default {
 ...
 the rsync client."
  ...
  rsyncmod_enabled_tooltip: T(
    "Activate this module for use with Rsync. Unset this \
field to deactivate the module without completely removing it."
 ...
 data."
  ...
  rsyncmod_maxconn_tooltip: T(
    "Maximum number of connections to this module. <i>0</i> \
 is unlimited."
  ),
 ...
 <code>Enter</code>.'
  ...
  rsyncmod_auxiliary_tooltip: T(
    'Enter any additional settings from <a\
 href="https://www.samba.org/ftp/rsync/rsyncd.conf.html"\
