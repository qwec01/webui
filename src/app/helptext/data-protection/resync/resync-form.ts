...
export default {
  ...
  rsync_path_tooltip: T(
    "Browse to the path to be copied. FreeBSD \
 ...
 destinations."
  ...
  rsync_user_tooltip: T(
    "Select the user to run the rsync task. The user\
  ...
  rsync_remotehost_tooltip: T(
    "Enter the IP address or hostname of the remote\
 ...
 of the rsync server or to use an SSH configuration for the rsync task."
  ...
  rsync_remotepath_tooltip: T(
    "Browse to the existing path on the remote host to\
  ...
  rsync_validate_rpath_tooltip: T(
    "Set to automatically create the defined <b>Remote\
  ...
  rsync_picker_tooltip: T(
    "Select a schedule preset or choose <i>Custom</i>\
                to open the advanced scheduler."
  ),

  rsync_recursive_placeholder: T("Recursive"),
  rsync_recursive_tooltip: T(
  ...
  rsync_compress_tooltip: T(
    "Set to reduce the size of data to transmit.\
                Recommended for slow connections."
  ),

  rsync_archive_placeholder: T("Archive"),
  rsync_archive_tooltip: T(
    "When set, rsync is run recursively, preserving\
  ...
  rsync_delayupdates_tooltip: T(
    "Set to save the temporary file from each updated\
  ...
  rsync_enabled_tooltip: T(
    "Enable this rsync task. Unset to disable this\
