...
export class GeneralPreferencesFormComponent
  ...
  onPreferences(prefs) {
    this.fieldSets[0].config = [
      ...
      },
      {
        ...
        tooltip: T(
          "When set, an <i>eye</i> icon appears next to \
 password fields. Clicking the icon reveals the password."
      ...
      },
      {
        ...
        value: false,
        tooltip: T(
          "Reset all user preferences to their default values. (Custom themes are preserved)"
        ),
        class: "inline",
      },
    ];
