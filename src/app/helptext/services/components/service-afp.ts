...
export default {
  ...
  afp_srv_guest_user_tooltip: T(
    "Select an account to use for guest access. This\
 ...
 used as guest account."
  ...
  afp_srv_guest_user_options: [{ label: "nobody", value: "nobody" }],

  afp_srv_guest_placeholder: T("Guest Access"),
  afp_srv_guest_tooltip: T(
    "Set to disable the password prompt that appears\
 before clients access AFP shares."
  ),

  afp_srv_connections_limit_placeholder: T("Max Connections"),
  afp_srv_connections_limit_tooltip: T(
 ...
 via AFP. The default limit is 50."
  ...
  afp_srv_dbpath_tooltip: T(
    "Sets the database information to be stored in the path.\
 The path must be writable even if the pool is read only."
  ),

  afp_srv_chmod_request_placeholder: T("Chmod Request"),
  afp_srv_chmod_request_tooltip: T(
    "Indicates how to handle Access Control Lists.\
 ...
 without any extra steps."
  ...
  afp_srv_map_acls_tooltip: T(
    "Select mapping of permissions for\
 ...
 or <b>Mode</b> (ACLs)."
  ...
  loglevel: {
    ...
    tooltip: T(
      "Record AFP service messages up to the specified log level in the system log. By default, severe and warning level messages are logged."
    ),
    options: [
      { label: T("None"), value: "NONE" },
  ...
  afp_srv_bindip_tooltip: T(
    "Specify the IP addresses to listen for AFP connections.\
 ...
 incoming request."
  ...
  afp_srv_global_aux_tooltip: T(
    'Additional <a href="http://netatalk.sourceforge.net/3.0/htmldocs/afp.conf.5.html"\
