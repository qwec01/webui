...
export default {
  ...
  bindip_tooltip: T(
    "Enter the IP address which runs the \
 S3 service. <i>0.0.0.0</i> tells the server to listen \
 on all addresses."
  ),
  bindip_options: [{ label: "0.0.0.0", value: "0.0.0.0" }],
...
<a href="https://docs.aws.amazon.com/general/latest/gr/aws-sec-cred-types.html#access-keys-and-secret-access-keys" target="_blank"> \
 ...
 Access keys</a> for more information.'
  ...
  secret_key2_validation: [
    matchOtherValidator("secret_key"),
    Validators.required,
    regexValidator(/^\w+$/),
  ],
  ...
  browser_tooltip: T(
    "Set to enable the web user interface for the S3 service. \
 ...
 separated by a colon in the browser address bar."
  ...
  mode_options: [{ label: "local" }],

  certificate_placeholder: T("Certificate"),
  certificate_tooltip: T(
    "Use an SSL certificate that was created or imported in \
 <b>System > Certificates</b> for secure S3 connections."
  ...
  path_warning_msg: T(
    "Selecting a dataset to use with Minio <strong>removes all existing\
