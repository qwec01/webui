...
const passphrase_msg = T(
  " a passphrase invalidates an existing pool \
...
export default {
  ...
  add_key_instructions: T(
    "The recovery key is an additional key file that \
 ...
 <b>INVALIDATE EXISTING KEY</b>."
  ...
  changekey_remove_passphrase_tooltip: T(
    "Delete the passphrase from \
 ...
 dialog prompts to back up the encryption key."
  ...
  rekey_instructions: T(
    "Reset the master key encryption used by this pool. \
 ...
 encryption key. This is used to lock and unlock the pool."
  ...
  set_recoverykey_checkbox_tooltip:
    "Download a new pool recovery key file \
 to the client system. Requires creating a new passphrase.",

  set_recoverykey_dialog_title: T("WARNING"),
  set_recoverykey_dialog_message: T(
    "The recovery key is used to decrypt \
