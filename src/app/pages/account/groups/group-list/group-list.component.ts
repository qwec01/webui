...
export class GroupListComponent implements OnDestroy {
  ...
  refreshGroupForm() {
    this.addComponent = new GroupFormComponent(
      this._router,
      this.ws,
      this.modalService
    );
      ...
      actions.push({
        ...
        onClick: (members_delete) => {
          ...
          const conf: DialogFormConfiguration = {
            ...
            message:
              helptext.deleteDialog.message + `<i>${members_delete.group}</i>?`,
            fieldConfig: [],
            ...
            preInit: function () {
              if (self.ableToDeleteAllMembers(members_delete)) {
                conf.fieldConfig.push({
                  ...
                  name: "delete_users",
                  placeholder: T(
                    `Delete all ${members_delete.users.length} users with this primary group?`
                  ),
                  value: false,
                });
              }
  ...
  toggleBuiltins() {
    let show;
    this.prefService.preferences.hide_builtin_groups
          ...
          this.translate
            ...
            .subscribe((message: string) => {
              this.dialogService
                ...
                .subscribe((res) => {
                  if (res) {
                    this.prefService.preferences.hide_builtin_groups = !this
                      .prefService.preferences.hide_builtin_groups;
  ...
  showOneTimeBuiltinMsg() {
    ...
    this.dialogService.confirm(
      helptext.builtinMessageDialog.title,
      helptext.builtinMessageDialog.message,
      true,
      helptext.builtinMessageDialog.button,
      false,
      "",
      "",
      "",
