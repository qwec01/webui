...
export class TooltipComponent {
  ...
  findParent() {
    ...
    if (this.tooltip.nativeElement.closest("mat-dialog-container")) {
      ...
      formParent.offsetParent &&
      formParent.offsetParent.tagName.toLowerCase() == "mat-card"
    ) {
      card = formParent.offsetParent;
    } else if (
      formParent.offsetParent.offsetParent &&
      formParent.offsetParent.offsetParent.tagName.toLowerCase() == "mat-card"
    ) {
      ...
      formParent.offsetParent.offsetParent.offsetParent.offsetParent &&
      formParent.offsetParent.offsetParent.offsetParent.offsetParent.tagName.toLowerCase() ==
        "mat-card"
    ) {
