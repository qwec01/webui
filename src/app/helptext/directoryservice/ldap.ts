...
export default {
 ...
 Separate entries by pressing <code>Enter</code>."
  ...
  ldap_hostname_noreq_tooltip: T(
    "LDAP server hostnames or IP addresses.\
 ...
 Example: <i>cn=Manager,dc=test,dc=org</i>."
  ...
  ldap_anonbind_tooltip: T(
    "Set for the LDAP server to disable authentication and\
 ...
 in <b>Directory Services > Kerberos Realms</b>."
  ...
  ldap_kerberos_principal_tooltip: T(
 ...
 on the default LDAP port <i>389</i>.</li> \
  ...
  ldap_certificate_tooltip: T(
    "Certificate to use when performing LDAP \
 ...
 username/password or Kerberos authentication."
  ...
  ldap_disable_fn_cache_tooltip: T(
    "Disable caching LDAP users and groups in large LDAP environments. \
 ...
 Kerberos ticket timeout occurs."
  ...
  ldap_idmap_backend_tooltip: T(
    "Backend used to map Windows security \
 ...
 upgrading legacy Samba domains to Samba AD domains.'
  ...
  ldap_auxiliary_parameters_tooltip: T(
 ...
 target="_blank">nslcd.conf</a>.'
  ...
  ldap_enable_tooltip: T(
    "Activates the configuration. Unset to disable the\
