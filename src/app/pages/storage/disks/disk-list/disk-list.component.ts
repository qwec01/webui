...
export class DiskListComponent {
                ...
                .subscribe((res) => {
                  if (res) {
                    ...
                    dialogRef.componentInstance.setDescription(
                      helptext.diskWipeDialogForm.startDescription
                    );
                    dialogRef.componentInstance.setCall("disk.wipe", [
                      entityDialogForm.formValue.disk_name,
                      entityDialogForm.formValue.wipe_method,
                    ]);
  ...
  diskUpdate(entityList: any) {
    for (const disk of entityList.rows) {
      disk.readable_size = (<any>window).filesize(disk.size, {
        standard: "iec",
      });
    }
  }
