...
export default {
 ...
 <i>No</i>. Passwords cannot contain a <b>?</b>."
  ...
  user_form_password_edit_tooltip: T(
    "Required unless <b>Enable password login</b> is\
 <i>No</i>. Passwords cannot contain a <b>?</b>."
  ),
  ...
  user_form_uid_tooltip: T(
    "User accounts have an ID greater than 1000 and\
 ...
 port number used by the service."
  ...
  user_form_group_create_tooltip: T(
    "Set to create a new primary group with the same name as\
 the user. Unset to select an existing group for the user."
  ...
  user_form_primary_group_tooltip: T(
    "New users are not given <b>su</b> permissions if\
 <i>wheel</i> is their primary group."
  ...
  user_form_dirs_explorer_tooltip: T(
 ...
 here when editing a user."
  ...
  user_form_home_dir_permissions_tooltip: T(
    "Sets default Unix permissions of the user home\
 directory. This is read-only for built-in users."
  ...
  user_form_auth_sshkey_tooltip: T(
    "Enter or paste the <b>public</b> SSH key of the\
 user for any key-based authentication. <b>Do not paste the private key.</b>"
  ...
  user_form_auth_pw_enable_tooltip: T(
    "<i>Yes:</i> Disables the <b>Password</b> \
 ...
 password-based services."
  ...
  user_form_lockuser_tooltip: T(
    "Prevent the user from logging in or \
 ...
 a <b>Password</b> has been created for the account."
  ...
  user_form_sudo_tooltip: T(
    'Give this user permission to use <a \
 ...
 a user is prompted for their account <b>Password</b>.'
  ...
  user_form_microsoft_tooltip: T(
    "Set to allow additional username authentication\
 methods when the user is connecting from a Windows 8 or newer operating system."
  ),
  user_form_blur_event2_warning: T(
    "Usernames can be up to 16 characters long.\
 When using NIS or other legacy software with limited username lengths,\
 keep usernames to eight characters or less for compatibility."
  ),
