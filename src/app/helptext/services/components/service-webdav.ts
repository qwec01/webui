...
export default {
  ...
  protocol_tooltip: T(
    "<i>HTTP</i> will keep the connection unencrypted.\
 ...
 <i>HTTP+HTTPS</i> allows both types of connections."
  ...
  tcpport_tooltip: T(
    "Specify a port for unencrypted connections. The\
 default port <i>8080</i> is recommended. Do not reuse\
 a port."
  ),

  tcpportssl_placeholder: T("HTTPS Port"),
  tcpportssl_tooltip: T(
    "Specify a port for encrypted connections. The\
 ...
 <i>Digest Authentication</i> is encrypted."
  ...
  password_tooltip: T(
    "The default of <i>davtest</i> is recommended to\
