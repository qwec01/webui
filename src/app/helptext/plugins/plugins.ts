...
network settings.'
  ...
  nat_tooltip: T(
    "Network Address Translation (NAT). Transforms local network IP addresses into a single IP address.\
 Set when the jail will share a single connection to the Internet with other systems on the network."
  ...
  ip4_addr_tooltip: T(
    "Enter a unique IPv4 address that is in the local \
network and not already in use."
  ...
  ip6_addr_tooltip: T(
    "Enter a unique IPv6 address that is in the local \
network and not already in use."
  ),
