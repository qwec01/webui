...
export class DatasetUnlockComponent implements OnDestroy {
  ...
  afterInit(entityEdit: any) {
    ...
    dialogRef.componentInstance.setDescription(
      helptext.fetching_encryption_summary_message + this.pk
    );
  ...
  customSubmit(body) {
    ...
    dialogRef.componentInstance.success.subscribe((res) => {
      ...
      if (!this.dialogOpen) {
        // prevent dialog from opening more than once
        this.dialogOpen = true;
        const unlockDialogRef: MatDialogRef<UnlockDialogComponent> = this.dialog.open(
