...
export const helptext_system_kmip = {
  ...
  certificate: {
    ...
    tooltip: T(
      "Certificate to use for key server authentication. A valid certificate is\
 ...
 the Certificate used for key server authentication."
  ...
  certificate_authority: {
    ...
    tooltip: T(
      "Certificate Authority (CA) to use for connecting to the key server. A valid\
 ...
 please protect the Certificate Authority used for key server authentication."
  ...
  manage_sed_disks: {
    ...
    tooltip: T(
      "Self-Encrypting Drive (SED) passwords can be managed with KMIP. Enabling this\
 ...
 this option leaves SED password management with the local system."
  ...
  manage_zfs_keys: {
    ...
    tooltip: T(
      "Use the KMIP server to manage ZFS encrypted dataset keys. The key server stores,\
 ...
 leaves all encryption key management with the local system."
  ...
  change_server: {
    ...
    tooltip: T(
      "Move existing keys from the current key server to a new key server. \
 ...
 enable this setting, update the key server connection configuration, and click <b>SAVE</b>."
  ...
  validate: {
    ...
    tooltip: T(
      "Tests the server connection and verifies the chosen <b>Certificate</b> \
