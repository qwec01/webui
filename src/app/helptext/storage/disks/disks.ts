...
export default {
  ...
  disk_form_hddstandby_tooltip: T(
    'Minutes of inactivity before the drive enters standby mode.\
 ...
 target="_blank">forum post</a> describes identifying spun down drives. Temperature monitoring is disabled for standby disks.'
  ...
  force_hdd_standby: {
    ...
    tooltip: T(
      "Allows the drive to enter standby, even when non-physical S.M.A.R.T. \
 operations could prevent the drive from sleeping."
  ...
  disk_form_advpowermgmt_options: [
    ...
    {
      label: T("Level 1 - Minimum power usage with Standby (spindown)"),
      value: "1",
    },
    {
      label: T("Level 64 - Intermediate power usage with Standby"),
      value: "64",
    },
    { label: T("Level 127 - Maximum power usage with Standby"), value: "127" },
    {
      label: T("Level 128 - Minimum power usage without Standby (no spindown)"),
      value: "128",
    },
    {
      label: T("Level 192 - Intermediate power usage without Standby"),
      value: "192",
    },
    {
      label: T("Level 254 - Maximum performance, maximum power usage"),
      value: "254",
    },
  ],

  disk_form_acousticlevel_placeholder: T("Acoustic Level"),
  disk_form_acousticlevel_tooltip: T(
 ...
 target="_blank">AAM</a>.'
  ...
  disk_form_togglesmart_tooltip: T(
    'Enabling allows the system to conduct periodic\
 <a href="--docurl--/tasks.html#s-m-a-r-t-tests" target="_blank">S.M.A.R.T. tests</a>.'
  ...
  disk_form_smartoptions_tooltip: T(
    'Additional <a\
 ...
 target="_blank">smartctl(8)</a> options.'
  ...
  disk_form_critical_tooltip: T(
    "Threshold temperature in Celsius. If the\
 ...
 is created and an email is sent. <i>0</i> disables this check."
  ...
  disk_form_difference_tooltip: T(
    "Report if the temperature of a drive\
 ...
 <i>0</i> disables the report."
  ...
  disk_form_informational_tooltip: T(
    "Report if drive temperature is at or\
 above this temperature in Celsius. <i>0</i> disables the report."
  ),

  disk_form_passwd_placeholder: T("SED Password"),
  disk_form_passwd_tooltip: T(
    "Set or change the password of this SED. \
