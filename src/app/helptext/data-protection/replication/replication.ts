...
export default {
  ...
  direction_tooltip: T(
    "<i>PUSH</i> sends snapshots to a destination \
 system.<br><br> \
 ...
 matching a <b>Naming Schema</b>."
  ...
  transport_tooltip: T(
    'Method of snapshot transfer:<ul> \
 ...
 and earlier.</li></ul>'
  ...
  ssh_credentials_tooltip: T(
    "Choose a connection that has been saved in \
 ...
 SSH connection hostname."
  ...
  source_datasets_tooltip: T(
    'Define the path to a system location \
 ...
 be selected or manually defined with a comma (<code>,</code>) separator.'
  ...
  target_dataset_tooltip: T(
    'Define the path to a system location that \
 ...
 snapshots."),
  ...
  replicate_tooltip: T(
    "Completely replicate the selected dataset. The target \
...
from the source dataset."
 ...
 schedule removes the <b>Schedule</b> field."
  ...
  naming_schema_tooltip: T(
    'Pattern of naming custom snapshots to be \
 ...
 entries by pressing <code>Enter</code>.'
  ...
  auto_tooltip: T(
    "Set to either start this replication task \
 ...
 continue to create a separate <b>Schedule</b> for this replication."
  ...
  schedule_picker_tooltip: T(
    "Select a preset schedule or choose \
 <i>Custom</i> to use the advanced scheduler."
  ...
  schedule_end_tooltip: T(
    "End time for the replication task. A \
 ...
 time."
  ...
  restrict_schedule_tooltip: T(
    "Only replicate snapshots that match a \
 ...
 choose <i>Custom</i> to use the advanced scheduler."
  ...
  restrict_schedule_begin_tooltip: T(
    "Daily time range for the specific \
 ...
 read over the <i>Replicate Specific Snapshots</i> time frame."
  ...
  readonly_tooltip: T(
    "<b>SET</b> will changes all destination datasets to <code>readonly=on</code>\
 ...
 <code>readonly</code> property during replication."
  ...
  encryption_key_location_truenasdb_placeholder: T(
 ...
 data transfer if the replication is misconfigured."
  ...
  hold_pending_snapshots_tooltip: T(
    "Prevent source system snapshots \
 ...
 <b>Snapshot Retention Policy</b>."
  ...
  retention_policy_tooltip: T(
    "When replicated snapshots are deleted \
 ...
 system.</li>"
  ...
  lifetime_value_tooltip: T(
    "How long a snapshot remains on the \
 ...
 the drop-down."
  ...
  compression_tooltip: T(
    "Select a compression algorithm to reduce the\
 ...
 bytes per second."),
  ...
  large_block_tooltip: T(
    'Allow this replication to send large data blocks. The \
...
*/
  ...
  compressed_tooltip: T(
    'Use compressed WRITE records to make the \
 ...
 target="_blank">zfs(8)</a>.'
  ...
  retries_tooltip: T(
    "Number of times the replication is attempted \
