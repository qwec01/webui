...
export const helptext_system_advanced = {
  ...
  consolemenu_tooltip: T(
    "Unset to add a login prompt to the system before\
 the console menu is shown."
  ...
  swapondrive_tooltip: T(
    "By default, all data disks are created with the amount\
 ...
 DISCOURAGED</b>"
  ...
  overprovision: {
    ...
    tooltip: T(
      "Overprovisioning a ZFS Log SSD can increase its performance and lifespan by \
 ...
 for GiB, like <code>256g</code> or <code>1 G</code> or <code>2 GiB</code>."
  ...
  autotune_tooltip: T(
    "Activates a tuning script which attempts to optimize \
 ...
 hardware issues."
  ...
  traceback_tooltip: T(
    "Provides a pop-up window of diagnostic information if a\
 fatal error occurs."
  ),
  ...
  fqdn_tooltip: T(
    "Set to include the Fully-Qualified Domain Name (FQDN)\
 ...
 syslog server."
  ...
  syslog_transport: {
    ...
    tooltip: T(
      '<a href="https://tools.ietf.org/html/rfc8095" target="_blank">Transport Protocol</a>\
 ...
 also requires selecting a preconfigured system Certificate.'
  ...
  syslog_tls_certificate: {
    ...
    tooltip: T(
      "The preconfigured system <i>Certificate</i> to use for authenticating\
