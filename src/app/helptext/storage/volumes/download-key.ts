...
export default {
  ...
  downloadkey_dialog_legacy_message: T(
    "Back up the encryption key now! If the key is lost,\
 ...
 data as a consequence of using this feature."
  ...
  downloadkey_dialog_zfs_message: T(
    "Losing the ability to unlock the pool can result in losing all\
