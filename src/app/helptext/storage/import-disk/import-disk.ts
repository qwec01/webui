...
export default {
  ...
  import_disk_volume_tooltip: T(
    "Select the disk to import. The import will copy the\
 ...
 Only one disk can be imported at a time."
  ...
  import_disk_msdosfs_locale_tooltip: T(
    "Select the locale for the MSDOSFS device to see files\
