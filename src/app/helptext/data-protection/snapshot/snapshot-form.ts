...
export default {
  ...
  recursive_tooltip: T(
    "Set to take separate snapshots of the \
 ...
 datasets."
  ...
  exclude_tooltip: T(
    "Exclude specific child datasets from the \
 ...
 <code>Enter</code>."
  ...
  lifetime_tooltip: T(
    "Define a length of time to retain the snapshot \
 ...
 to other systems are not affected."
  ...
  naming_schema_tooltip: T(
    'Snapshot name format string. The default \
 ...
 or choose <i>Custom</i> to use the advanced scheduler."
  ...
  allow_empty_tooltip: T(
    "Creates dataset snapshots even when there \
 ...
 already taken a snapshot of any changes to the dataset."
  ...
  enabled_tooltip: T(
    "To activate this periodic snapshot schedule, set \
