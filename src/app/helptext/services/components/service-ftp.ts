...
export default {
 ...
 <i>0</i> means unlimited."
  ...
  loginattempt_tooltip: T(
    "Enter the maximum number of attempts before client is\
 disconnected. Increase this if users are prone to typos."
  ...
  onlyanonymous_tooltip: T(
    "Allow anonymous FTP logins with access to the \
 directory specified in <b>Path</b>."
  ...
  onlylocal_tooltip: T(
    "Allow any local user to log in. By default, only \
 members of the <i>ftp</i> group are allowed to log in."
  ),

  banner_placeholder: T("Display Login"),
  banner_tooltip: T(
    "Specify the message displayed to local login users after\
 ...
 To create a certificate, use <b>System --> Certificates</b>."
  ...
  fxp_tooltip: T(
    "Set to enable the File eXchange Protocol. This option\
 ...
 it is not recommended."
  ...
  ident_tooltip: T(
    "Setting this option will result in timeouts if\
 <b>identd</b> is not running on the client."
  ),

  passiveportsmin_placeholder: T("Minimum Passive Port"),
  passiveportsmin_tooltip: T(
    "Used by clients in PASV mode. A default of <i>0</i>\
 ...
 means any port above 1023."
  ...
  tls_tooltip: T(
    "Allow encrypted connections. Requires a certificate \
 created or imported with the <b>System > Certificates</b> menu."
  ),

  tls_policy_placeholder: T("TLS Policy"),
  tls_policy_tooltip: T(
    'Define whether the control channel, \
 ...
 target="_blank">mod_tls</a> for more details.'
  ...
  tls_opt_allow_dot_login_tooltip: T(
    "If set, the user home directory is checked\
 ...
 authentication."
  ...
  tls_opt_common_name_required_tooltip: T(
    "When set, the common name in the certificate must\
 match the FQDN of the host."
  ),

  tls_opt_enable_diags_placeholder: T("TLS Enable Diagnostics"),
  tls_opt_enable_diags_tooltip: T(
    "If set when troubleshooting a connection, logs more\
 verbosely."
  ),
  ...
  tls_opt_no_cert_request_tooltip: T(
    "Set if the client cannot connect, and\
 it is suspected the client is poorly handling the server certificate request."
  ...
  tls_opt_no_empty_fragments_tooltip: T(
    "Enabling this option is <b>not</b> recommended as it\
 ...
 understand reused SSL sessions."
  ...
  tls_opt_dns_name_required_tooltip: T(
    "If set, the DNS name of the client must resolve to\
 its IP address and the cert must contain the same DNS name."
  ...
  tls_opt_ip_address_required_tooltip: T(
    "If set, the client certificate must contain\
