...
export const customSvgIcons = {
  ...
  truenas_logomark_color:
    "assets/customicons/truenas_enterprise_logomark_rgb.svg",
  truenas_logotype_color:
    "assets/customicons/truenas_enterprise_logotype_rgb.svg",
  ...
  truenas_enterprise_logomark:
    "assets/customicons/truenas_enterprise_logomark.svg",
  truenas_enterprise_logotype:
    "assets/customicons/truenas_enterprise_logotype.svg",
  truenas_enterprise_logo_full:
    "assets/customicons/truenas_enterprise_logo_full.svg",
  ...
  truenas_core_logomark_color:
    "assets/customicons/truenas_core_logomark_rgb.svg",
  truenas_core_logotype_color:
    "assets/customicons/truenas_core_logotype_rgb.svg",
  ...
  truenas_scale_logomark_color:
    "assets/customicons/truenas_scale_logomark_rgb.svg",
  ...
  truecommand_logo_blue:
    "assets/images/truecommand/truecommand-logo-mark-full-color-rgb.svg",
  truecommand_logo_white:
    "assets/images/truecommand/truecommand-logo-mark-white-rgb.svg",
  ...
  "network-upload-download-disabled":
    "assets/customicons/network-upload-download-disabled.svg",
};
