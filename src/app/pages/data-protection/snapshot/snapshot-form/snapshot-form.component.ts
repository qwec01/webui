...
export class SnapshotFormComponent implements OnDestroy {
  ...
  beforeSubmit(value) {
    ...
    value["lifetime_unit"] = _.endsWith(lifetime[1], "S")
      ? lifetime[1].substring(0, lifetime[1].length - 1)
      : lifetime[1];
