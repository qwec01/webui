...
export const helptext_system_certificates = {
 ...
 the system."
    ...
    csr_create_type: {
      placeholder: T("Type"),
      tooltip: T(
        "<i>Certificate Signing Request</i> is used to get a CA signature. \
 ...
 to be imported onto the system."
      ...
      options: [
        ...
        {
          label: T("Import Certificate Signing Request"),
    ...
    profiles: {
      ...
      tooltip: T(
        "Predefined certificate extensions. Choose a profile that best \
matches your certificate usage scenario."
    ...
    signedby: {
      ...
      tooltip: T("Select a previously imported or created CA."),
 ...
 for more information.'
      ...
      path_length: {
        ...
        tooltip: T(
          "How many non-self-issued intermediate certificates that can follow \
...
additional certificate to follow in the certificate path. Cannot be less than <i>0</i>."
      ...
      extension_critical: {
        ...
        tooltip: T(
          "Identify this extension as critical for the certificate. Critical extensions must \
...
certificate still approved."
 ...
 for more information.'
      ...
      authority_cert_issuer: {
        ...
        tooltip: T(
          "Pair this certificate's public key with the Certificate Authority private \
...
certificate still approved."
    ...
    extended_key_usage: {
      usages: {
        ...
        tooltip: T(
          'Identify the purpose for this public key. Typically used for end \
...
certificate still approved."
 ...
 for more information.'
      ...
      digital_signature: {
        ...
        tooltip: T(
          "This certificate's public key is used with digital signature methods \
that are separate from certificate or CRL signing."
      ...
      content_commitment: {
        ...
        tooltip: T(
          "This certificate's public key verifies digital signatures used for a \
non-repudiation service."
      ...
      key_cert_sign: {
        ...
        tooltip: T(
          "This certificate's public key is used to verify signatures on \
...
<b>CA</b> basic constraint."
      ...
      crl_sign: {
        ...
        tooltip: T(
          "This certificate's public key is used to verify signatures \
on a certificate revocation list (CRL)."
      ...
      encipher_only: {
        ...
        tooltip: T(
          "The certificate's public key is used to encipher user \
...
<b>Key Agreement</b> is also set."
      ...
      decipher_only: {
        ...
        tooltip: T(
          "This certificate's public key is used to decipher \
...
certificate still approved."
 ...
 Server."
    ...
    dir_uri: {
      ...
      tooltip: T(
        "URI of the ACME Server Directory. Choose a\
 preconfigured URI or enter a custom URI."
    ...
    authenticator: {
      ...
      tooltip: T(
        "Authenticator to validate the Domain. Choose a\
