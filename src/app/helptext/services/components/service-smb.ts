...
export default {
  ...
  cifs_srv_netbiosname_tooltip: T(
 ...
 cannot be the <b>Workgroup</b> name."
  ...
  cifs_srv_netbiosalias_tooltip: T(
    "Enter any aliases, separated by spaces.\
 Each alias can be up to 15 characters long."
  ...
  cifs_srv_workgroup_tooltip: T(
    "Must match Windows workgroup name. \
 ...
 TrueNAS will detect and set the correct workgroup from these services."
  ...
  cifs_srv_unixcharset_tooltip: T(
    "Default is UTF-8 which supports all characters in\
 all languages."
  ),

  cifs_srv_loglevel_placeholder: T("Log Level"),
  cifs_srv_loglevel_tooltip: T(
    "Record SMB service messages up to the specified log level. \
 By default, error and warning level messages are logged."
  ...
  cifs_srv_syslog_tooltip: T(
    "Set to log authentication failures in <i>/var/log/messages</i>\
 instead of the default of <i>/var/log/samba4/log.smbd</i>."
  ),

  cifs_srv_localmaster_placeholder: T("Local Master"),
  cifs_srv_localmaster_tooltip: T(
    "Set to determine if the system participates in\
 ...
 This is required for Time Machine support.'
  ...
  cifs_srv_guest_tooltip: T(
    "Account to be used for guest access. Default is \
 ...
 is deleted the field resets to <i>nobody</i>."
  ...
  cifs_srv_filemask_tooltip: T(
    "Overrides default file creation mask of <i>0666</i> \
 which creates files with read and write access for everybody."
  ),

  cifs_srv_dirmask_placeholder: T("Directory Mask"),
  cifs_srv_dirmask_tooltip: T(
    "Overrides default directory creation mask of <i>0777</i> \
 which grants directory read, write and execute access for everybody."
  ...
  cifs_srv_admin_group_tooltip: T(
    "Members of this group are local admins\
 ...
 Computer Management MMC snap-in."
  ...
  cifs_srv_smb_options_tooltip: T(
    'Enter additional <b>smb.conf</b> options. See the \
 ...
 <code>log level = 1, auth_audit:5</code>.'
  ...
  cifs_srv_ntlmv1_auth_tooltip: T(
 ...
 untrusted networks.'
  ...
  cifs_srv_bindip_tooltip: T(
    "Static IP addresses which SMB listens on for connections. \
 Leaving all unselected defaults to listening on all active interfaces."
  ),

  idmap_tdb_range_low_placeholder: T("Range Low"),
  idmap_tdb_range_low_tooltip: T(
    "The beginning UID/GID for which this system is\
 ...
 defined IDs."
  ...
  idmap_tdb_range_high_tooltip: T(
    "The ending UID/GID for which this system is authoritative.\
 ...
 and remotely defined IDs."
  ...
  cifs_srv_enable_smb1_tooltip: T(
