...
export class SupportComponent implements OnInit {
  ...
  protected licenseComponent = new LicenseComponent(
    this.ws,
    this.modalService,
    this.loader,
    this.dialog
  );
  protected supportFormLicensed = new SupportFormLicensedComponent(
    this.mdDialog,
    this.loader,
    this.ws,
    this.dialog,
  ...
  protected supportFormUnlicensed = new SupportFormUnlicensedComponent(
    this.ws,
    this.mdDialog,
    this.modalService
  );
  protected proactiveComponent = new ProactiveComponent(
    this.ws,
    this.loader,
    this.dialog,
    this.translate,
  ...
  doProdUpdate(entityDialog: any) {
    ...
    const dialogRef = entityDialog.mdDialog.open(EntityJobComponent, {
      data: {
        title: helptext.is_production_job.title,
